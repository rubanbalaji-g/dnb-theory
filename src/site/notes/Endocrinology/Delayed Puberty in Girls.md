---
{"dg-publish":true,"permalink":"/endocrinology/delayed-puberty-in-girls/","dgPassFrontmatter":true}
---
...
- Associated genetic mutations: _IGSF10_ (dysregulates GnRH neuronal migration from olfactory bulb to hypothalamus), _FTO_ variants.
...
- _SHOX_ gene haploinsufficiency causes profound short stature and skeletal anomalies (short fourth metacarpal, cubitus valgus).
...
- **Gonadotropins (LH, FSH):** Differentiates primary vs. secondary hypogonadism.
    - _Elevated FSH/LH:_ Primary ovarian insufficiency (hypergonadotropic).
    - _Low/Normal FSH/LH:_ CDGP or hypogonadotropic hypogonadism.
...
- **Dosing Strategy:** Begin with very low-dose estrogen. Gradually escalate every 6 months to adult replacement dose over 2.5 to 3.0 years.
    ...
    - _Oral Conjugated Estrogens:_ 0.15 - 0.3 mg daily. Escalate to 0.625 - 1.25 mg daily.
    - _IM Depot Estradiol:_ 0.2 mg/month. Escalate to 1.0 - 1.5 mg/month.
- _Note:_ Oral contraceptive pills (OCPs) contain supraphysiological estrogen doses and are contraindicated for initial pubertal induction.
