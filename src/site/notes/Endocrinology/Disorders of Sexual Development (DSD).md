---
{"dg-publish":true,"permalink":"/endocrinology/disorders-of-sexual-development-dsd/","dgPassFrontmatter":true}
---
...
|:--|:--|:--|
|**4–6 Weeks**|Urogenital ridge develops from intermediate mesoderm.|Requires _WT1_, _SF1_, _GATA4_ expression.|
...
|Gestational Age|Developmental Event|Genetic/Endocrine Correlate|
|:--|:--|:--|
|**6–7 Weeks**|Primitive Sertoli cells appear; first evidence of testicular differentiation.|Triggered by _SRY_ gene expression in supporting cells.|
|**7–8 Weeks**|Pre-Sertoli cells form testicular cords. Fetal Leydig cells appear.|Requires _SOX9_ expression; _DMRT1_ prevents transdifferentiation.|
...
|Gestational Age|Developmental Event|Genetic/Endocrine Correlate|
|:--|:--|:--|
|**6–9 Weeks**|Upregulation of female-specific genes (_WNT4_, _CTNNB1_).|_FOXL2_ represses _SOX9_ to suppress testicular pathway.|
...
- Requires specific transcription factors for somatic cell development: _WT1_, _SF1_ (_NR5A1_), _GATA4_, _CBX2_, _EMX2_, _LIM1_.
...
- Initiated at 6-7 weeks by _SRY_ gene on Y chromosome.
- _SRY_ triggers _SOX9_ expression, crucial for Sertoli cell differentiation.
...
- Independent of _SRY_.
- Driven by ovary-specific genes: _WNT4_, _RSPO1_, _FOXL2_, _DAX1_ (_NR0B1_).
- _WNT4_ and _DAX1_ suppress androgen synthesis and repress the testicular pathway.
...
- **11β-Hydroxylase Deficiency (_CYP11B1_):**
...
- **3β-Hydroxysteroid Dehydrogenase Deficiency (_HSD3B2_):**
...
- **Placental Aromatase Deficiency (_CYP19A1_):**
...
- **46,XX Testicular DSD (XX Male):**
    - _SRY_ gene translocated to X chromosome during paternal meiosis (90% of cases).
    - Normal male external genitalia; small azoospermic testes.
    - SRY-negative cases (10%) linked to _SOX9_ duplication or _RSPO1_ mutation.
...
- **Androgen Insensitivity Syndrome (AIS):** X-linked recessive _AR_ mutations.
...
- **Persistent Müllerian Duct Syndrome (PMDS):** Mutations in _AMH_ or _AMHR2_. Fully virilized male with bilateral cryptorchidism and retained uterus/fallopian tubes.
...
- **Gonadectomy:** Mandatory if Y-chromosome material (_TSPY_ gene) is present in a dysgenetic streak gonad or intra-abdominal testis (e.g., Mixed Gonadal Dysgenesis, Swyer syndrome) due to 15-40% risk of gonadoblastoma/dysgerminoma.
