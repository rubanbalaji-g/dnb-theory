---
{"dg-publish":true,"permalink":"/endocrinology/adrenal-crisis/","dgPassFrontmatter":true}
---
...
- The profound hypotension and decreased cardiac output impair glomerular filtration, further limiting the kidney's ability to excrete free water; this is exacerbated by the non-osmotic release of arginine vasopressin (ADH), which is no longer inhibited by cortisol, worsening the dilutional hyponatremia.
- Hypoglycemia is a hallmark of the crisis, driven by the loss of cortisol's normal functions in promoting gluconeogenesis, glycogen storage, and lipolysis.
- Furthermore, cortisol is required for the transcription of phenylethanolamine N-methyltransferase in the adrenal medulla; its absence impairs the conversion of norepinephrine to epinephrine, further blunting the counterregulatory defense against hypoglycemia.
...
- In the neonatal period, massive adrenal hemorrhage can occur secondary to a difficult or traumatic labor, particularly involving a breech presentation, or birth asphyxia.
...
- **Gastrointestinal Symptoms:** Acute, severe anorexia, intractable nausea, recurrent vomiting, and acute abdominal or flank pain that can mimic an acute surgical abdomen.
- **Neurological and Systemic Signs:** Extreme weakness, fatigue, apathy, profound lethargy progressing to coma, and high fever (which may be secondary to the precipitating infection or inherent to the crisis itself).
- **Cutaneous Signs:** In primary adrenal insufficiency, there is characteristic hyperpigmentation of the skin (especially sun-exposed areas, extensor surfaces, palmar creases, and surgical scars) and mucous membranes (gingiva) due to massively elevated ACTH and melanocyte-stimulating hormone (MSH).
...
- **Intravenous Fluid Therapy:** The immediate priority is the aggressive restoration of intravascular volume and the correction of hypoglycemia and hyponatremia.
- Resuscitation should commence with an initial rapid fluid bolus of normal saline (0.9% NaCl) or 5% dextrose in 0.9% saline (D5NS) at a dose of 20 mL/kg over the first hour, repeated as necessary until hemodynamic stability and adequate peripheral perfusion are restored.
- Hypotonic fluids (such as 0.2% saline or 5% dextrose in water) are strictly contraindicated, as they will rapidly exacerbate the dilutional hyponatremia, potentially precipitating cerebral edema and herniation.
- **Glucocorticoid Administration:** High-dose, water-soluble intravenous glucocorticoids must be administered immediately. Hydrocortisone sodium succinate is the drug of choice.
- The initial immediate intravenous bolus dose is 50 mg/m² of body surface area.
- Alternatively, standard age-based initial bolus doses are: 10 mg for infants, 25 mg for toddlers, 50 mg for older children, and 100 mg for adolescents.
- Following the initial bolus, a maintenance stress dose of hydrocortisone (typically 100 mg/m²/day) must be continued, administered either as a continuous intravenous infusion or divided into equal doses given strictly every 6 hours to maintain continuously high serum cortisol levels.
...
- The patient must remain under continuous intensive clinical and laboratory monitoring, assessing hourly vital signs, strict fluid input and output, neurological status, and frequent serum electrolyte and glucose measurements until stabilized.
- Precipitating factors, such as underlying bacterial sepsis or systemic infections, must be aggressively identified and treated with appropriate broad-spectrum intravenous antibiotics.
- Once the child is hemodynamically stable, tolerating oral intake, and the precipitating illness is resolving, the massive intravenous stress doses of hydrocortisone are gradually tapered over several days down to the standard physiologic maintenance dosage.
- The chronic oral maintenance dose of hydrocortisone is typically 10 to 15 mg/m²/day, administered in three divided doses to roughly mimic the normal physiological circadian rhythm and minimize growth suppression.
- As the hydrocortisone dose is tapered below 50 mg/m²/day, its inherent mineralocorticoid effect diminishes; at this point, oral fludrocortisone acetate must be initiated in patients with primary adrenal insufficiency or salt-wasting CAH.
- The typical maintenance dose of fludrocortisone is 0.05 to 0.2 mg administered orally once daily.
- Neonates and infants with salt-wasting CAH exhibit profound renal resistance to mineralocorticoids and typically require higher doses of fludrocortisone (up to 0.4 mg/day) combined with mandatory dietary sodium chloride supplementation (typically 8 mmol/kg/day or 1-2 grams/day).

### Prevention and Stress Dosing

- The cornerstone of preventing future crises is comprehensive, repetitive education of the parents, caregivers, and school personnel regarding "sick day rules" and the critical necessity of stress dosing.
- For minor physiological stress (e.g., fever > 101°F, mild viral infections, gastroenteritis, or minor surgical procedures), the oral hydrocortisone dose must be immediately tripled (3 times the physiological requirement) and maintained throughout the duration of the illness.
- For severe physiological stress (e.g., major systemic infections, trauma), the glucocorticoid dose must be increased to 4 to 5 times the basal requirement.
- If a child experiences persistent vomiting, severe diarrhea, or major trauma rendering oral medication administration impossible, caregivers must be trained and equipped to immediately administer an intramuscular injection of hydrocortisone at home.
- The recommended emergency home intramuscular hydrocortisone doses are 25 mg for infants, 50 mg for children under 4 years of age, and 100 mg for older children and adolescents.
- During major surgery under general anesthesia, patients require continuous high-dose intravenous hydrocortisone (e.g., 25 mg/m² added to the intravenous fluids to run continuously during the procedure) to replicate the massive physiological cortisol surge required to survive anesthesia reversal and surgical trauma.