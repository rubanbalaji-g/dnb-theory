---
{"dg-publish":true,"permalink":"/endocrinology/tft-interpretation/","noteIcon":"","dgPassFrontmatter":true}
---
...
- Thyroid Antibodies:
	- TPOAb (Thyroid Peroxidase Antibodies): A marker of autoimmune thyroid damage. Its presence is diagnostic for [[Endocrinology/Hashimoto's Thyroiditis\|Hashimoto's thyroiditis]] (the most common cause of primary hypothyroidism) and is also found in a majority of patients with Graves' disease.
...
| ------------- | ------------- | ------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| High          | Low           | Low / Normal  | Overt Primary Hypothyroidism                   | [[Endocrinology/Hashimoto's Thyroiditis\|Hashimoto's thyroiditis]], post-thyroidectomy, radioiodine therapy, drug-induced (e.g., Lithium).                                                      |
...
- Routine TFT screening in hospitalized patients is discouraged. Reverse T3 (rT3) is typically high in NTI (due to reduced clearance), whereas it is low in central hypothyroidism, but this test is rarely used.
### 2. Drug Interference
...
- Amiodarone: Due to its high iodine content and direct cellular toxicity, it can cause:
	- Amiodarone-Induced Hypothyroidism (AIH): More common in iodine-sufficient areas (Wolff-Chaikoff effect[^wolff-chaikoff]).
	- Amiodarone-Induced Thyrotoxicosis (AIT): Type 1 (Jod-Basedow effect[^joe-basedow] in underlying thyroid disease) or Type 2 (destructive thyroiditis).
...
- Key Point: Trimester-specific reference ranges for TSH must be used for all pregnant patients.
  ...
  [^wolff-chaikoff]: The **Wolff-Chaikoff effect** is an auto-regulatory mechanism where high levels of circulating iodide cause a temporary **inhibition of [[Endocrinology/Thyroid Hormone Synthesis\|thyroid hormone synthesis]]**. It occurs because the excess iodide prevents the organification of iodine, effectively "shutting down" the production of T3 and T4 to prevent hyperthyroidism. This effect is usually transient, as the gland typically "escapes" the inhibition after 10 to 14 days by downregulating the sodium-iodide symporter.
  [^joe-basedow]: The **Jod-Basedow effect** is a form of iodine-induced **hyperthyroidism** that occurs when a sudden increase in iodine intake triggers excessive hormone production in a predisposed thyroid. It typically affects individuals with underlying conditions like multi-nodular goiter or Graves' disease, where parts of the gland operate autonomously and lack the normal regulatory "shut-off" mechanisms. Unlike the Wolff-Chaikoff effect, which causes a temporary drop in hormone levels, the Jod-Basedow effect results in a sustained, overactive state.