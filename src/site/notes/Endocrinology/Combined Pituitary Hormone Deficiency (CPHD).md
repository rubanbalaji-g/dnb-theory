...
- If both ACTH and TSH are deficient, glucocorticoid replacement (hydrocortisone) must absolutely be initiated _before_ thyroid hormone (levothyroxine) replacement; administering thyroxine first accelerates cortisol clearance and can precipitate a fatal acute adrenal crisis.
