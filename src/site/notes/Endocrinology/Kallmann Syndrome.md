...
- The X-linked form accounts for approximately 15% of cases and is caused by mutations in the _KAL1_ gene, which encodes the cell adhesion protein anosmin-1.
- The autosomal dominant form (sometimes referred to as KAL2) occurs in up to 10% of patients and is frequently caused by loss-of-function variants in the Fibroblast Growth Factor Receptor 1 (_FGFR1_) gene.
- Other implicated genes include _FGF8_, _PROK2_, _PROKR2_, _WDR11_, and _CHD7_.
...
- **Associated Systemic Anomalies:** Phenotypic expression is highly variable even within families. Features can include unilateral renal agenesis, bimanual synkinesia (mirror movements), sensorineural hearing loss, color blindness, and midline facial defects such as cleft lip and palate (which is particularly associated with _FGFR1_ variants).
