---
{"dg-publish":true,"permalink":"/neurology/hydrocephalus/"}
---
...
```mermaid
flowchart TD
    A[Lateral Ventricles] --> B[Foramen of Monro<br/>Interventricular Foramen]
    B --> C[Third Ventricle]
    C --> D[Aqueduct of Sylvius<br/>Midbrain]
    D --> E[Fourth Ventricle]
    E --> F[Foramina of Luschka<br/>Lateral]
    E --> G[Foramen of Magendie<br/>Medial]
    F --> H[Subarachnoid Space<br/>Cisterna Magna & Basal Cisterns]
    G --> H
    H --> I[Circulates over cerebral convexities<br/>and spinal cord]
```
<!-- /htmlmin:ignore -->
**3. Absorption**
