---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/viral-encephalitis/","dgPassFrontmatter":true}
---
...
* **Prodrome:** Fever, malaise, headache (1–7 days).
* **Neurological Phase:**
...
* **CSF Findings:**
    ...
    * **Cells:** Pleocytosis (10–500 cells/mm³). Early: Polymorphonuclear; Late: Lymphocytic predominance.
...
* **Transmission:** Pig (Amplifying host) $\rightarrow$ Culex Mosquito $\rightarrow$ Human (Dead-end host).
* **Prevention (Vaccines):**
...
* **Mortality:** High in untreated HSV (70%) and JE (20–30%).
* **Sequelae:**
