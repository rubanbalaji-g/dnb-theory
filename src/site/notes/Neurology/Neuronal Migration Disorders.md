---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/neuronal-migration-disorders/","dgPassFrontmatter":true}
---
...
- **Subcortical Band Heterotopia (Double-Cortex Syndrome):**
    ...
    - X-linked mutation in _DCX_ gene (affects females; males typically exhibit classic lissencephaly).
...
- **Periventricular Nodular Heterotopia:**
    ...
    - Strongly associated with X-linked _FLNA_ mutations (primarily females affected).
...
- **Etiology:** Genetic (_COL4A1_, _SHH_, _SIX3_) or acquired in-utero insults (infections, infarcts, hemorrhages).
...
- **Genetic Testing:** Next-generation sequencing or gene panels targeting mTOR pathway, tubulinopathies, and _LIS1_/_DCX_ genes.
