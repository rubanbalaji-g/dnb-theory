---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/pediatric-stroke/","dgPassFrontmatter":true}
---
...
* **Morbidity:** > 60% of survivors have permanent neurological deficits ([[Neurology/Cerebral Palsy\|Cerebral Palsy]], Epilepsy).
### 3. Etiology and Risk Factors (The "Black Box")
Unlike adults (where atherosclerosis/HTN dominates), [[Neurology/Pediatric Stroke\|pediatric stroke]] is multifactorial.

| Category | Specific Causes / Risk Factors |
| :--- | :--- |
| **Arteriopathies** (50-80% of AIS) | • **Focal Cerebral Arteriopathy (FCA):** Transient inflammatory stenosis (often post-Varicella).<br>• **Moyamoya Disease:** Chronic progressive stenosis of distal ICA.<br>• **Arterial Dissection:** Post-trauma (even minor neck trauma) or spontaneous.<br>• **Vasculitis:** PAN, Takayasu, Primary CNS vasculitis. |
| **Cardiac Disorders** (25%) | • **Congenital Heart Disease:** Cyanotic > Acyanotic (R-to-L shunt).<br>• **Procedures:** [[Cardiology/Cardiac Catheterization\|Cardiac catheterization]], ECMO.<br>• **Infection:** [[Cardiology/Infective endocarditis\|Infective Endocarditis]].<br>• **Cardiomyopathy/Arrhythmias.** |
| **Hematologic** | • **[[Hematology/Sickle Cell Disease\|Sickle Cell Disease]]:** Highest risk (10% risk without screening).<br>• **Prothrombotic States:** Protein C/S deficiency, Factor V Leiden, Antithrombin III deficiency.<br>• **[[Hematology/Iron Deficiency Anemia\|Iron Deficiency Anemia]]:** Thrombocytosis/hyperviscosity. |
| **Infectious** | • **Post-Varicella Angiopathy:** Stroke 3–12 months after Chickenpox.<br>• **[[Neurology/Meningitis\|Meningitis]]:** Bacterial (Pneumococcal/TB) causing vasculitis.<br>• **Head/Neck Infections:** Mastoiditis (Risk of CSVT). |
...
2.  **Hemiplegic [[Neurology/Migraine\|Migraine]]:** Strong family history; headache follows aura.
3.  **Intracranial Infection:** Abscess, [[Neurology/ADEM\|ADEM]] (Acute Disseminated Encephalomyelitis).
...
* **Cardiac:** Echocardiography (Transthoracic/Transesophageal) with bubble study (for PFO). [[Misc/ECG\|ECG]].
* **Vascular:** Carotid Doppler (if dissection suspected).
* **Blood Work:**
    * CBC (Sickle cell, Polycythemia, Platelets).
    * Coagulation profile (PT/APTT).
    * [[Hematology/Thrombophilia\|Thrombophilia]] screen (Protein C, S, AT3, Factor V Leiden, Lipoprotein-a, Homocysteine).
...
1.  **Stabilization (ABC):**
    ...
    * **Seizures:** Treat aggressively (Benzodiazepines $\rightarrow$ Levetiracetam).
...
* **[[Hematology/Sickle Cell Disease\|Sickle Cell Disease]]:** **Exchange Transfusion** to reduce HbS < 30%. Chronic hypertransfusion program thereafter.
...
* **Neurological Outcome:**
    * **Hemiplegic [[Neurology/Cerebral Palsy\|Cerebral Palsy]]:** Most common motor sequela.
    * **Epilepsy:** Develops in 25% of survivors.
    * **Cognitive:** Learning disabilities, [[Development/ADHD\|ADHD]], behavioral issues.
