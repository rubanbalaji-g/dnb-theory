---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/infantile-spasms/","dgPassFrontmatter":true}
---
...
| :--- | :--- |
| **ACTH (Adrenocorticotropic Hormone)** | **First-line choice** for non-TSC cases. Stimulates endogenous steroid production. <br>*Dose:* High dose vs Low dose (controversial); usually short course (2–4 weeks). <br>*Side Effects:* Hypertension, infection risk, electrolyte imbalance. |
...
| **Vigabatrin** | **Drug of Choice for Tuberous Sclerosis (TSC).** Irreversible GABA-transaminase inhibitor. <br>*Side Effect:* Concentric visual field constriction (Retinal toxicity) – requires monitoring. |
