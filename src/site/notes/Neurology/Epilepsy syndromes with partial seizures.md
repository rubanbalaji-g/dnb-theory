---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/epilepsy-syndromes-with-partial-seizures/","dgPassFrontmatter":true}
---
...
* **Clinical:**
    ...
    * **Progression:** Intractable seizures $\rightarrow$ Hemiparesis $\rightarrow$ Cognitive decline (dementia).
...
| :--- | :--- | :--- |
| **Pharmacotherapy** | First line for all focal epilepsies (except self-limiting with rare events). | **1st Line:** Carbamazepine, Oxcarbazepine, Levetiracetam.<br>**2nd Line:** Lacosamide, Lamotrigine, Topiramate, Zonisamide.<br>**Avoid:** Ethosuximide (ineffective), Phenobarbital (cognitive side effects). |
| **Dietary** | Drug-resistant cases (esp. young children). | Ketogenic Diet, Modified Atkins Diet. |
| **Surgery** | Drug-resistant focal epilepsy (failure of 2 drugs) with identifiable focus. | **Resective:** Lobectomy, Lesionectomy.<br>**Disconnective:** Hemispherectomy (Rasmussen, Hemimegalencephaly), Corpus Callosotomy.<br>**Palliative:** VNS, RNS. |