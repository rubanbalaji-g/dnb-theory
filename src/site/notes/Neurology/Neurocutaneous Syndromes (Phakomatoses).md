---
{"dg-publish":true,"uplink":"/neurology/neurology/","uptext":"Back to Index (Neurology)","permalink":"/neurology/neurocutaneous-syndromes-phakomatoses/","dgPassFrontmatter":true}
---
...
Diagnosis requires **$\ge$ 2** of the following 7 features:
...
* **Mechanism:** Failure to inhibit the **mTOR pathway** $\rightarrow$ uncontrolled cell growth.
...
**1. Genetics**
* **Mutation:** Somatic activating mutation in **_GNAQ_** gene.
...
* **Clinical Features:**
    ...
    * **Immunity:** T-cell and B-cell deficiency (low IgA/IgE) $\rightarrow$ sinopulmonary infections.
