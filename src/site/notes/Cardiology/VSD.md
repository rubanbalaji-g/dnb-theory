---
{"dg-publish":true,"uplink":"/cardiology/cardiology/","uptext":"Back to Index (💗 Cardiology)","permalink":"/cardiology/vsd/","dgPassFrontmatter":true}
---
...
* **Volume Overload:** Increased flow to Pulmonary Artery $\rightarrow$ Lungs $\rightarrow$ LA $\rightarrow$ LV.
* *Key Concept:* VSD causes volume overload of the **Left Atrium and Left Ventricle** (and RV pumping against pressure, not volume, unless huge).
### 3. Clinical Features
