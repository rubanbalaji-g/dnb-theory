...
- Accounts for 5-10% of isolated congenital heart disease (CHD).
- Incidence: 100 per 100,000 live births.
- Characterized by abnormal communication between right and left atria.
- Allows left-to-right shunting, increasing pulmonary blood flow.
...
- Older patients: Fatigue, dyspnea, effort intolerance, recurrent respiratory infections, palpitations,,.
- Right-sided heart failure, peripheral edema, syncope develop late.
...
- **Complications:** Embolization, arrhythmias, device erosion. Erosion specifically linked to deficient retroaortic rim,.
