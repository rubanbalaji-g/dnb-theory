...
1.  **P**ulmonary Stenosis (RV outflow tract obstruction - infundibular or valvular).
2.  **R**ight Ventricular Hypertrophy (RVH).
3.  **O**verriding of the Aorta.
4.  **V**SD (Ventricular Septal Defect) - large, malaligned.
...
* If RV obstruction is severe $\rightarrow$ Right-to-Left shunt $\rightarrow$ Cyanosis.
* If RV obstruction is mild $\rightarrow$ Left-to-Right shunt $\rightarrow$ "Pink Tet".
### 2. Clinical Features
* **Symptoms:** Cyanosis (often appears later as infundibular stenosis worsens), Dyspnea on exertion, Failure to thrive.
* **Squatting:** Child squats after play to increase SVR (kinking femoral arteries) $\rightarrow$ reduces R-L shunt $\rightarrow$ improves oxygenation.
* **Tet Spells (Cyanotic Spells):**
* most common in the morning
    * *Triggers:* Crying, feeding, defecation (morning).
    * *Mechanism:* Spasm of infundibulum $\uparrow$ RVOT obstruction $\rightarrow$ $\uparrow$ R-L shunt $\rightarrow$ $\downarrow$ $pO_2$ $\rightarrow$ Metabolic acidosis $\rightarrow$ $\uparrow$ Respiratory drive $\rightarrow$ More negative intrathoracic pressure $\rightarrow$ More venous return $\rightarrow$ Cycle continues.
...
* **Definitive:** **Intracardiac Repair** (usually at 6-12 months).
    ...
    2.  Resection of infundibular muscle / Pulmonary valvotomy (RVOT relief).
### 6. Complication
- Cerebral thrombosis
- Brain abscess
