...
flowchart TD
    ...
    B -->|SpO2 < 90%<br>in RH or Foot| C[FAIL Screen]
    B -->|SpO2 >= 95% in RH/Foot<br>AND Difference <= 3%| D[PASS Screen]
    B -->|SpO2 90-94% in RH/Foot<br>OR Difference > 3%| E[Repeat Screen<br>in 1 Hour]

    E --> F{Second SpO2<br>Measurement}

    F -->|SpO2 < 90%<br>in RH or Foot| C
    F -->|SpO2 >= 95% in RH/Foot<br>AND Difference <= 3%| D
    F -->|SpO2 90-94% in RH/Foot<br>OR Difference > 3%| G[Repeat Screen<br>in 1 Hour]

    G --> H{Third SpO2<br>Measurement}

    H -->|SpO2 < 90%<br>in RH or Foot| C
    H -->|SpO2 >= 95% in RH/Foot<br>AND Difference <= 3%| D
    H -->|SpO2 90-94% in RH/Foot<br>OR Difference > 3%| C
