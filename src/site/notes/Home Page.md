...
<div style="
    ...
    color: #f1f5f9;
    text-align: center;
"><header style="margin-bottom: 40px;"><h1 style="
    font-size: 3.2rem;
    font-weight: 800;
...
">PediaNotes</h1><style>
    @keyframes shine {
        ...
        ">Notes by Dr. Ruban</p><div style="
            ...
            margin: 25px auto 0;
        "></div></header><section style="margin-bottom: 45px; max-width: 680px; margin-left: auto; margin-right: auto;"><p style="
            font-size: 1.15rem;
            line-height: 1.75;
            color: #94a3b8;
            margin-bottom: 24px;
    ...
    "><a href="https://www.pedianotes.in/index-of-notes"
           ...
           onmouseout="this.style.transform='translateY(0)'; this.style.backgroundColor='#ffffff';">Explore the Notes →</a><div style="
            display: grid;
        ...
        "><a href="https://qb.pedianotes.in"
            ...
            >DNB Question Bank</a><a href="https://page.pedianotes.in"
               style="
                padding: 16px;
                background: rgba(255, 255, 255, 0.04);
                border: 1px solid rgba(255, 255, 255, 0.08);
               ...
               onmouseout="this.style.borderColor='rgba(255, 255, 255, 0.08)'; this.style.background='rgba(255, 255, 255, 0.04)';"
            >Calculators & Tools</a></div></div></div>
