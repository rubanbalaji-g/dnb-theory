---
{"dg-publish":true,"uplink":"/respiratory/respiratory-system/","uptext":"Back to Index (🫁Respiratory System)","permalink":"/respiratory/viral-croup/","dgPassFrontmatter":true}
---
...
* **Mild (Score ≤ 2-3):** Occasional barking cough, no stridor at rest, child happy/eating.
* **Moderate (Score 4–7):** Stridor at rest, retractions present, but no agitation.
* **Severe (Score ≥ 8):** Significant stridor at rest, marked retractions, agitation/lethargy (hypoxia).
...
* **Mechanism:** Vasoconstriction of mucosal arterioles $\rightarrow$ decreased edema.
* **Dose:** **L-Epinephrine (1:1000)** 0.5 ml/kg (Max 5 ml) nebulized with saline.
* **Observation:** Patient must be observed for **2–4 hours** post-nebulization for "Rebound phenomenon" (return of stridor).
