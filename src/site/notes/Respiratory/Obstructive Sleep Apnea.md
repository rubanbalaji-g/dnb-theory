---
{"dg-publish":true,"uplink":"/respiratory/respiratory-system/","uptext":"Back to Index (🫁Respiratory System)","permalink":"/respiratory/obstructive-sleep-apnea/","dgPassFrontmatter":true}
---
...
- This results in either a complete cessation of airflow (apnea) or a partial cessation (hypopnea) at the nose and/or mouth, leading to disrupted sleep.
    - **Hypopnea**: Defined as a >30% reduction in airflow accompanied by a $\ge 3\%$ O2​ desaturation and/or an arousal from sleep.
...
- <span style="color:red">Adenotonsillar hypertrophy</span> is the most frequent cause of upper airway obstruction.
...
<span style="color:orange">The decision to treat depends on the severity of symptoms, sleep study results, duration of the disease, and individual patient factors</span>.
