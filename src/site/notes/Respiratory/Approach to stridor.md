...
1.  **Acute Laryngotracheobronchitis ([[Respiratory/Viral Croup\|Viral Croup]])
...
| **Fever** | Low to Moderate | High (>39°C) |
...
| :--- | :--- |
| **Viral Croup** | • **Dexamethasone** (0.15–0.6 mg/kg stat).<br>• **Nebulized Adrenaline** (if moderate/severe).<br>• Cool mist/Cold air. |
| **Acute Epiglottitis** | • **Secure Airway** (Intubation).<br>• IV Antibiotics (**Ceftriaxone**).<br>• Avoid throat exam/agitation. |
| **Foreign Body** | • **Rigid Bronchoscopy** for removal.<br>• Heimlich maneuver (only if complete obstruction/choking). |
| **Bacterial Tracheitis** | • IV Antibiotics (Anti-Staph).<br>• Aggressive pulmonary toilet/suctioning.<br>• Intubation often required. |
| **Laryngomalacia** | • **Conservative:** Most resolve by 18-24 months.<br>• **Surgical:** Supraglottoplasty (if failure to thrive/severe apnea). |
| **Hypocalcemia** | • **IV Calcium Gluconate** (for laryngeal tetany). |
