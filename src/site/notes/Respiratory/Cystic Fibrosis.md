---
{"dg-publish":true,"uplink":"/respiratory/respiratory-system/","uptext":"Back to Index (🫁Respiratory System)","permalink":"/respiratory/cystic-fibrosis/","dgPassFrontmatter":true}
---
...
- **Mechanism (Airway):**
	1. Impaired $Cl^-$ secretion into lumen.
	2. **Hyperabsorption of $Na^+$** (via disinhibited ENaC)
	3. Water follows $Na^+$ paracellularly $\rightarrow$ **Dehydrated Airway Surface Liquid (ASL)**.
	4. Ciliary dyskinesia + Viscous mucus $\rightarrow$ Bacterial colonization.      
...
- **Prophylaxis/Eradication:** Early eradication of _P. aeruginosa_ (Inhaled Tobramycin + Oral Ciprofloxacin).
...
- _Note:_ Systemic steroids only for ABPA/Asthma.
