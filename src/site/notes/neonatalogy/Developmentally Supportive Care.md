...
## 2. **H**ealing Environment

Modifying sensory inputs to prevent overstimulation across five specific domains:
...
- **A. Visual Stimulation**
    ...
    - **Interaction:** Avoid talking while encouraging eye contact (prevents sensory overload). The infant may only tolerate brief exposure to the mother's face (held 20–25 cm away). Avoid forcing the infant to look at overhead lights (causes arching).
...
- **C. Olfactory & Gustatory**
    - **Pungency:** Avoid pungent smells like alcohol wipes, strong perfumes, or oils near the infant.
- **D. Vestibular (Movement)**
    - **Handling:** Gently roll the infant during position changes (do not flip).
    - **Transfers:** Swaddle during transfers to prevent sudden movements.
- **E. Tactile (Touch)**
...
## 3. **A**llie-ing with Families (Family-Centered Care)
...
## 4. **P**ositioning and Handling

- **Goal:** Promote symmetric development and physiologic stability.
- **Positions:**
    - **Prone:** Facilitates flexion and early head control. Legs should be weight-bearing on knees; hips flexed <90°.
...
## 5. **E**radicating Stress and Pain (Minimizing Stress and Pain)
...
- **Topicals:** Avoid using lotions and soaps.
- **Adhesives:** Protect skin during removal of adhesives/tapes.
- **Injuries:** Prevent pressure sores and device-related injuries.

## 7. **N**utrition Optimized

- **Goal:** Feeding should be a positive, non-stressful experience.
- **Practices:**
    - **State of Wakefulness:** Feed only when the infant is awake, not asleep. Do not wake the infant by pinching or flicking soles/ears.
    - **Support:** Swaddle and support head/neck during spoon/paladai feeding.
    - **Focus:** Avoid multitasking (singing/talking) during the feed to prevent distraction.        
