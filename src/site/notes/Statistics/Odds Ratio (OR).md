...
- The [[Statistics/Odds Ratio (OR)\|odds ratio (OR)]] is an epidemiological and statistical measure of association defined as the ratio of two odds, such as the odds of an event occurring in an exposed group compared to the odds of the same event in an unexposed or control group.
...
- The odds ratio is the fundamental effect estimate generated by logistic [[Statistics/Regression Analysis\|regression analysis]].
...
- The following table contrasts the Odds Ratio with the [[Statistics/Relative Risk (RR)\|Relative Risk (RR)]], another common measure of association:

|Feature|[[Statistics/Odds Ratio (OR)\|Odds Ratio (OR)]]|[[Statistics/Relative Risk (RR)\|Relative Risk (RR)]]|
|:--|:--|:--|
...
- To calculate a 95% [[Statistics/Confidence Interval\|confidence interval]] (CI), a logarithmic transformation must be applied first to normalize the distribution.
...
- If the 95% [[Statistics/Confidence Interval\|confidence interval]] for an odds ratio includes the null value of 1, the observed association is considered not statistically significant.
- If the 95% [[Statistics/Confidence Interval\|confidence interval]] does not contain 1, the odds ratio is considered statistically significant.
- The exact p-value for the significance of an OR generated from a 2x2 contingency table is formally obtained by utilizing either the Fisher's exact test or the [[Statistics/Chi-Square Test\|Chi-square test]].