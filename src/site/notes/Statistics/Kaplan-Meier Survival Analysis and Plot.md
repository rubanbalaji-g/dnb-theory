...
- **Kaplan-Meier (KM) survival plot**, is a fundamental non-parametric statistical method used in survival analysis to estimate and graph the probability of survival over time.
