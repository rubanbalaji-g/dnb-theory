...
|:--|:--|
|**Horizontal Axis**|Represents the scale of the chosen effect measure, such as the [[Statistics/Odds Ratio (OR)\|Odds Ratio (OR)]], [[Statistics/Relative Risk (RR)\|Relative Risk (RR)]], Absolute Risk Reduction (ARR), or Standardized Mean Difference (SMD).|
