...
- **Adenosine:** Administered via rapid intravenous push using a 'two-syringe' technique (drug followed immediately by a rapid $\ge$ 5 ml normal saline flush). The initial dose is 0.1 mg/kg (maximum first dose 6 mg). If there is no response, the dose is doubled to 0.2 mg/kg (maximum second dose 12 mg).
...
- **Lidocaine:** Administered as a 1 mg/kg intravenous bolus, which can be followed by a continuous infusion of 20 to 50 $\mu$g/kg/min.