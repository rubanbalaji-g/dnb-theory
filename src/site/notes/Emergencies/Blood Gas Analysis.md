...
- A ratio $> 2.0$ suggests a slower fall in $HCO_3^-$ relative to the increase in AG, indicating the concomitant presence of a metabolic alkalosis.
...
- The $PaO_2/FiO_2$ (P:F) ratio is a standard metric for oxygenation impairment; a normal value is $300-500$, while a ratio $<200$ defines severe impairment consistent with Acute [[neonatalogy/Respiratory Distress in Newborns\|Respiratory Distress Syndrome]] (ARDS).
