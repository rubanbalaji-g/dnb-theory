...
- If the heart rate remains $< 60$ beats per minute and is associated with poor systemic perfusion despite effective ventilation and oxygen administration, the provider must immediately start chest compressions.
- During this phase, it is critical to continue supporting the airway, maintaining ventilation, and providing oxygenation alongside chest compressions.
...
- If the bradycardia persists or responds only transiently to bolus medications, a continuous infusion of Epinephrine ($0.1-0.3$ $\mu$g/kg/min) or Isoproterenol should be considered.
