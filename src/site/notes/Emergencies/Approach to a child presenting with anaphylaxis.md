...
- The standard pediatric dose is $0.01$ mg/kg of the $1:1,000$ ($1$ mg/mL) solution, administered via the intramuscular (IM) route.
- The maximum single dose is $0.5$ mg for an older child or adolescent.
- This IM dose can and should be repeated $2-3$ times every $5-15$ minutes if the child's clinical condition does not rapidly improve or if symptoms recur.
...
- Isotonic crystalloids (Normal Saline or Ringer's Lactate) should be administered as rapid IV boluses of $20$ mL/kg.
- Repeat fluid boluses may be necessary if hypotension or signs of poor perfusion persist, with continuous reassessment for signs of fluid overload.
...
- The continuous epinephrine infusion should be started at $0.1$ $\mu$g/kg/min and can be titrated upwards to $1$ $\mu$g/kg/min based on continuous hemodynamic monitoring and clinical response.
- Ensure the complete removal of the inciting agent if it is still present (e.g., removing a stinger, discontinuing an offending intravenous medication or blood product).
