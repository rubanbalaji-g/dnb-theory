...
| :--------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------- |
| **Normal Physiologic State**                         | $\gt$ 94% on room air indicates normal systemic oxygenation.                                                                |
...
- The SpO2 is used to calculate the Oxygen Saturation Index O2 × mean airway pressure × 100) / SpO2.
...
- To accurately calculate the SF ratio and OSI, the SpO2 must be documented at ≤ 97%, as values above this threshold limit the mathematical reliability of the Index.
...
| **Carbon Monoxide Poisoning**                           | Pulse oximetry does not accurately reflect oxyhemoglobin saturation in the presence of carboxyhemoglobin (COHb). <br>It may falsely display normal saturation levels, necessitating the use of co-oximetry or arterial [[Emergencies/Blood Gas Analysis\|blood gas analysis]] to establish the diagnosis of CO toxicity. |
| **[[Hematology/Methemoglobinemia\|Methemoglobinemia]]** | The presence of methemoglobin (metHb) renders standard pulse oximetry highly inaccurate. <br>Patients may present with profound cyanosis refractory to oxygen therapy despite normal or raised PaO2 on an ABG; specific co-oximetry or enzyme assays must be utilized.                                                   |
