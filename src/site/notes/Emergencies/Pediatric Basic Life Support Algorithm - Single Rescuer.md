...
- If a palpable pulse is present (and $\ge$ 60 beats/min) but breathing is inadequate, the rescuer should provide isolated rescue breaths at a rate of 12 to 20 breaths per minute (1 breath every 3 to 5 seconds).
- If the pulse is absent, or if the heart rate is $< 60$ beats/min accompanied by signs of poor systemic perfusion, the rescuer must immediately initiate cardiopulmonary resuscitation (CPR).
