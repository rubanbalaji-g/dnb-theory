...
- Special criteria apply for cyanotic heart disease, chronic lung disease, and left ventricular dysfunction, where an acute deterioration in oxygenation not explained by the underlying disease confirms [[Emergencies/PARDS\|PARDS]].
...
|**Plateau Pressure**|Targeted $\le$ 28 cm H2O (allowing 29-32 cm H2O for patients with decreased chest wall compliance).|
|**Permissive Hypoxemia**|Target SpO2 92-97% (PEEP < 10 cm H2O) or 88-92% (PEEP $\ge$ 10 cm H2O).|
|**Permissive Hypercapnia**|Accept elevated PaCO2 while maintaining pH $\ge$ 7.15 - 7.30 (unless contraindicated by intracranial hypertension or significant ventricular dysfunction).|
