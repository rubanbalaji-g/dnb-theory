...
- **[[Emergencies/Oxygenation Index\|Oxygenation Index]]:** OI incorporates the airway pressure required to maintain oxygenation, calculated as: `(Mean Airway Pressure × FiO2 × 100) / PaO2`. It is a highly robust physiological Index where values > 16 indicate severe pediatric ARDS and significant hypoxemic respiratory failure.
- **Oxygen Saturation Index non-invasive surrogate, calculated as: `(Mean Airway Pressure × FiO2 × 100) / SpO2`. An OSI > 12.3 is diagnostic of severe respiratory failure and ARDS.