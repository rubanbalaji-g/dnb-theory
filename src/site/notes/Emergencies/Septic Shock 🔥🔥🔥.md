---
{"dg-publish":true,"uptext":"Back to Index (🚑 Emergencies and Critical Care)","uplink":"/emergencies/emergencies-and-critical-care/","permalink":"/emergencies/septic-shock/","dgPassFrontmatter":true}
---
...
| :-------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Respiratory** | * PaO2 / FiO2 < 300 (in the absence of cyanotic heart disease or preexisting lung disease). * PaCO2 > 65 mm Hg, or a 20 mm Hg increase over baseline PaCO2. * Proven need for > 50% FiO2 to maintain oxygen saturation ≥ 92%. * Need for non-elective invasive or non-invasive mechanical ventilation. |
| **Neurologic**  | * Glasgow Coma Score ≤ 11. * Acute change in mental status with a decrease in the Glasgow Coma Score of ≥ 3 points from an abnormal baseline.                                                                                                                                                          |
| **Hematologic** | * Platelet count < 80,000/mm³ or a decline of 50% from the highest value recorded over the past 3 days. * International Normalized Ratio (INR) > 2.                                                                                                                                                    |
| **Renal**       | * Serum creatinine ≥ 2 times the upper limit of normal for age, or a 2-fold increase in baseline creatinine.                                                                                                                                                                                           |
| **Hepatic**     | * Total bilirubin ≥ 4 mg/dl (not applicable for newborns). * ALT ≥ 2 times the upper limit of normal for age.                                                                                                                                                                                          |
...
_Note: Table adapted from clinical and laboratory features of 'Cold shock' and 'Warm shock'._

## Management of Septic Shock
![Pasted image 20260324215708.png](/img/user/+%C4%B0mages/Pasted%20image%2020260324215708.png)
<i><sup>Management of Septic Shock(AHA)</i></sup>

![Pasted image 20260324220007.png](/img/user/+%C4%B0mages/Pasted%20image%2020260324220007.png)
<sup><i>Initial Management of Septic Shock (Surving Sepsis Guidelienes)</i></sup>

![Pasted image 20260324220027.png](/img/user/+%C4%B0mages/Pasted%20image%2020260324220027.png)
...
- Vasoactive medications are initiated for fluid refractory shock; the choice of agent is determined by the clinical phenotype (cold vs. warm shock).
- Epinephrine or norepinephrine can both be utilized as first-line agents; dopamine is an acceptable alternative if the primary agents are unavailable.
- For **Cold Shock** (low cardiac output, high systemic vascular resistance), reversal is attempted by titrating an epinephrine infusion.
- For **Warm Shock** (diffuse vasodilation, wide pulse pressure, low blood pressure), a norepinephrine infusion (0.1-1 $\mu$g/kg/min) is the treatment of choice to restore vascular tone.
- **Inodilators**, such as milrinone, are highly indicated in children who exhibit persistent hypoperfusion, high systemic vascular resistance, and documented cardiac dysfunction despite the use of epinephrine.
- **Vasopressin** may be considered as a rescue therapy for patients presenting with warm shock and low blood pressure that remains entirely unresponsive to high-dose norepinephrine.

### Antimicrobial Therapy and Source Control

- Timely administration of appropriate antimicrobials is a critical pillar of management; delayed administration directly correlates with increased morbidity and mortality.
- Intravenous antimicrobials must be administered within 1 hour of presentation for a child in septic shock.
- Blood cultures (at least two sets) should be obtained before initiating antibiotics, provided this does not significantly delay the antimicrobial administration.
- Source control—such as the drainage of an abscess, debridement of infected necrotic tissue, or removal of a potentially infected intravascular access device—must be evaluated and executed within 6 hours of presentation.

### Corticosteroids and Host Response Interventions

- Corticosteroids are not recommended for routine use in pediatric septic shock.
- They are specifically indicated for children with catecholamine-resistant (refractory) shock who have proven or suspected adrenal insufficiency.
- The recommended regimen in fluid and catecholamine-refractory shock is intravenous Hydrocortisone (50 to 100 mg/m$^2$/dose or 1 to 2 mg/kg/dose), which should be discontinued once the patient achieves hemodynamic stability and no longer requires vasoactive support.
- Intravenous immunoglobulin (IVIG) is not recommended for routine management in pediatric sepsis or septic shock due to inadequate supporting data.

### Supportive Care and Organ System Management

- **Mechanical Ventilation:** Early intubation and mechanical ventilation reduce the work of breathing (which can account for 15% to 30% of oxygen consumption in septic shock) and allow for the redistribution of limited cardiac output to vital organs.
- Etomidate and propofol should be avoided during intubation to prevent adrenal suppression and metabolic acidosis; Ketamine is the preferred induction agent if not contraindicated.
- **Blood Products:** The optimal hemoglobin threshold for transfusion in severe sepsis remains unclear, but guidelines suggest withholding RBC transfusions if the hemoglobin is $\ge$ 7 g/dL in hemodynamically stable children.
- Prophylactic platelet transfusions are generally indicated if counts are < 5,000/mm$^3$, or between 5,000-30,000/mm$^3$ with a significant risk of bleeding; fresh frozen plasma (FFP) is reserved exclusively for patients with active bleeding or prior to invasive procedures, rather than for correcting isolated laboratory coagulopathies.
- **Glycemic Control:** Blood glucose should be meticulously monitored to avoid both hypoglycemia and hyperglycemia. Levels exceeding 180 mg/dl should be managed with low-dose insulin infusions, while targeting a strict normoglycemic range (e.g., <140 mg/dL) is not recommended due to the high risk of fatal hypoglycemia.
- **Nutrition:** Early initiation of enteral feeding (gastric over post-pyloric) is highly recommended, whereas Total Parenteral Nutrition (TPN) should be avoided during the first week of illness.