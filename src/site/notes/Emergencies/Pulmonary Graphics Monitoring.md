...
||The corresponding peak volume on the Y-axis denotes the tidal volume ($V_T$).|
...
||Choosing appropriate inspiratory pressure: An over-distended lung (decreased compliance) is seen as "beaking" of the P-V loop, where the compliance of the last 20% of the curve is lower than the compliance of the entire loop; this requires lowering either PIP or $V_T$.|
...
||Increased airway resistance is indicated when both the flow and $V_T$ are reduced.|
