---
{"dg-publish":true,"permalink":"/development/growth-charts/"}
---
...
- **Percentile Charts (NCHS/CDC):**
    ...
    - The 50th percentile is the median. The CDC 2000 charts are considered "references" describing how a population grows on average, rather than how it _should_ grow,.
...
- **Prescriptive Nature:** Unlike previous charts (like NCHS) which were _descriptive_ (how children _do_ grow), the WHO charts are _prescriptive_ (how children _should_ grow) when their nutritional and health needs are met,.
