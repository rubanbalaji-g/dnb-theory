...
- The onset of symptoms must be during the developmental period, before adulthood (18 to 22 years of age).
- Intellectual disability is a nonprogressive disorder; any regression of milestones or downward developmental trajectory suggests an alternative diagnosis, such as a neurodegenerative disorder.
- The estimated prevalence of developmental delay and ID is between 2.5% and 5%, with global prevalence estimates for ID being approximately 10.4 per 1,000 persons.

## Etiology

- An exact etiology can be defined in approximately 70% of patients presenting with developmental disorders.
- In children with severe ID, a biologic cause can be identified in about 75% of cases.
- Mild ID is frequently associated with nongenetic risk factors, including low socioeconomic status, low maternal education, malnutrition, and poor access to healthcare.
...
- The essential principle in early diagnosis is that the child with ID is backward in all fields of development from birth or before birth, except occasionally in gross motor development and rarely in sphincter control.
- The child is relatively more compromised in language and speech, and in demonstrating general awareness, concentration, alertness, and promptness of response.
...
- Early signs of ID include lateness in smiling and taking notice, delayed following with the eyes, and a delayed response to sound.
- Persistence of primitive behaviors strongly points to ID, including hand regard persisting beyond 20 weeks, mouthing of objects persisting at 2 or 3 years of age, casting of objects long after 15 or 16 months, and prolonged slobbering.
- Children with severe ID frequently exhibit aimless over-activity, tooth grinding (bruxism) while awake, lack of joint engagement, imitation deficits, and self-injurious behaviors.
