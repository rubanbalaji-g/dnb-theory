...
graph TD
    classDef default fill:#e3f2fd,stroke:#1565c0,color:#1565c0,stroke-width:2px;
    classDef action fill:#e8f5e9,stroke:#2e7d32,color:#2e7d32,stroke-width:2px;
    ...
    classDef tm fill:#ffebee,stroke:#c62828,color:#c62828,stroke-width:2px;
    classDef tn fill:#fff9c4,stroke:#f57f17,color:#f57f17,stroke-width:2px;

    Start[Acute Flaccid Paralysis Presentation] --> Notify[Mandatory Action: Notify Surveillance Medical Officer]:::action
