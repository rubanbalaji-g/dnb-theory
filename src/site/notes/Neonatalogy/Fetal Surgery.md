...
2.  **FETO (Fetoscopic Endoluminal Tracheal Occlusion):**
    ...
    * *Principle:* A balloon occludes the trachea (26–28 weeks) $\rightarrow$ Lung fluid is trapped $\rightarrow$ Lungs expand against the herniated viscera ("Stretch to Grow").
...
* *Steps:*
    ...
    3.  Airway secured (Laryngoscopy $\rightarrow$ Bronchoscopy $\rightarrow$ Tracheostomy).
