---
{"dg-publish":true,"uptext":"Back to Index (Neonatology)","uplink":"/neonatology/","permalink":"/neonatalogy/hypoxemic-ischemic-encephalopathy/","dgPassFrontmatter":true}
---
...
* Hypoxia/Ischemia $\rightarrow$ Anaerobic metabolism $\rightarrow$ Depletion of ATP.
* Failure of $Na^+/K^+$ pump $\rightarrow$ Influx of $Na^+, Ca^{2+}, H_2O$.
* **Result:** Cytotoxic edema and acute necrosis.
* Release of excitatory neurotransmitters (Glutamate) $\rightarrow$ NMDA receptor overactivation $\rightarrow$ Excitotoxicity.
...
* **Term Infants:**
    * **Acute Profound Asphyxia:** Damages high-metabolic areas $\rightarrow$ Basal Ganglia, Thalamus, Brainstem (Deep Gray Matter injury). Associated with dyskinetic CP.
...
> [!crit] 6 Important Domains of SARNAT staging - Mnemonic
...
> [!crit] Mnemonic
>**F** — **F**eeding (Sucking ability)
**A** — **A**lertness (Level of Consciousness)
**C** — **C**onvulsions (Seizures)
**T** — **T**one (Muscle tone)
**S** — **S**pontaneous Respiration (Breathing effort)
### Other Staging
- Thompson Staging
...
* **Respiratory:**
    * Maintain normal oxygenation ($SpO_2$ 90–95%, $PaO_2$ 50–80 mmHg). **Avoid Hyperoxia.**
    * Maintain Normocapnia ($PaCO_2$ 40–50 mmHg). **Avoid Hypocarbia** (causes cerebral vasoconstriction).
* **Cardiovascular:**
    * Maintain mean arterial pressure (MAP) in normal range.
    * Treat hypotension/shock judiciously (Volume $\rightarrow$ Dobutamine/Dopamine/Epinephrine). Functional Echo is useful.
* **Metabolic:**
