...
### **Mechanism of Action**
* **Vagal Stimulation:** Moderate pressure stimulates pressure receptors $\rightarrow$ increased vagal tone $\rightarrow$ increased release of Gastrin and Insulin $\rightarrow$ better food absorption and anabolism.
...
* **Sequence:** Generally head-to-toe; includes strokes from face $\rightarrow$ chest $\rightarrow$ abdomen $\rightarrow$ limbs $\rightarrow$ back.
