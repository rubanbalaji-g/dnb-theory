...
## 1. DEFINITIONS
* **Neonatal Hypothermia (WHO):** Axillary temperature $<36.5^{\circ}C$ ($97.7^{\circ}F$).
...
* **Normal Range:** $36.5^{\circ}C - 37.5^{\circ}C$.
...
1.  **Warm Delivery Room:** Temperature $25-28^{\circ}C$, draft-free.
...
### A. Classification
* **Cold Stress:** $36.0^{\circ}C - 36.4^{\circ}C$.
* **Moderate Hypothermia:** $32.0^{\circ}C - 35.9^{\circ}C$.
* **Severe Hypothermia:** $<32.0^{\circ}C$.

### B. Action Plan
**1. Cold Stress ($36.0-36.4^{\circ}C$):**
...
**2. Moderate Hypothermia ($32.0-35.9^{\circ}C$):**
