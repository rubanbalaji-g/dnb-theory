...
## Introduction
Umbilical cord milking (UCM) involves stripping blood from the umbilical cord toward the newborn. It is a rapid method to achieve placental transfusion (within seconds) compared to Delayed Cord Clamping (DCC), which requires $\ge 60$ seconds.

## Current Guidelines (NRP 9th Edition & ILCOR)
Guidelines are stratified by gestational age and vigor:

1.  **Term and Late Preterm ($\ge 35$ weeks):**
...
* **Comparison with DCC:** While UCM provides volume expansion similar to DCC, it does not provide the sustained oxygenation that occurs during the physiological transition of DCC (where the infant breathes while attached to the placenta).
...
* Delayed separation ($>3$ weeks) warrants evaluation for urachal anomalies or Leukocyte Adhesion Deficiency (LAD).
