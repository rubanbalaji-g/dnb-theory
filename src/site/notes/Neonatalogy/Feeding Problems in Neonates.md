---
{"dg-publish":true,"permalink":"/neonatalogy/feeding-problems-in-neonates/","dgPassFrontmatter":true}
---
...
5.  **Candida Treatment:** If nipples are itchy/pink/shiny, treat mother and baby with topical Nystatin or Clotrimazole.

### B. Breast Engorgement
**Definition:** Painful overfilling of breasts causing lymphatic and venous obstruction, usually on Day 3–5.

**Management:**
1.  **Frequent Feeding:** Nurse frequently to empty breasts.
2.  **Warm Compresses:** Apply *before* feeding to stimulate oxytocin and let-down.
3.  **Cold Compresses:** Apply *after* feeding to reduce edema and pain.
4.  **Cabbage Leaves:** Clean, chilled cabbage leaves applied to the breast can reduce edema (mechanism unclear but widely accepted).
5.  **Reverse Pressure Softening:** Gentle pressure around the areola to push fluid back and allow the baby to latch.
...
**Management:**
1.  **Continue Breastfeeding:** Essential to drain the breast; stopping worsens the condition. Start feeding from the unaffected side to stimulate let-down, then switch.
2.  **Analgesics:** Ibuprofen or Paracetamol for pain and fever.
3.  **Antibiotics:** Indicated if symptoms persist >24 hours, fissure is present, or systemic sepsis signs appear.
...
**Management:**
1.  **Antenatal:** Hoffman’s exercises (rolling nipple) are *no longer routinely recommended* (risk of preterm labor).
2.  **Postnatal:**
...
**Diagnosis:** Confirmed only if infant weight gain is poor (<15–30g/day) or urine output is low (<6 wet diapers/day).

**Management:**
1.  **Counseling:** Reassure mother (growth spurts often mimic low supply).
2.  **Frequent Nursing:** Supply equals demand; nurse more often.
