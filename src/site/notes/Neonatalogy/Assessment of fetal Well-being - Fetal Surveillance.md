---
{"dg-publish":true,"permalink":"/neonatalogy/assessment-of-fetal-well-being-fetal-surveillance/","dgPassFrontmatter":true}
---
...
| :--- | :--- |
| **Maternal Conditions** | • Diabetes Mellitus (Pre-gestational & GDM)<br>• Hypertension / Preeclampsia<br>• Chronic Renal Disease<br>• SLE / APLA Syndrome<br>• Cyanotic Heart Disease |
...
* **Cardiff "Count-to-Ten" Formula:** Mother counts movements starting at 9 AM.
    ...
    * **Alarm Signal:** <10 movements in 12 hours $\rightarrow$ Requires NST.
...
1.  **Umbilical Artery (UA):** reflects placental resistance.
    * progression: High Resistance $\rightarrow$ Absent End Diastolic Flow (**AEDF**) $\rightarrow$ Reversed End Diastolic Flow (**REDF**).
...
* **Protocol:** Every 15–30 mins in active phase; every 5 mins in second stage.
...
* **Key Parameters:**
    1.  **Baseline Rate:** Normal 110–160 bpm.
    2.  **Variability:** Most important indicator of oxygenation. Normal (Moderate) = 6–25 bpm.
    3.  **Accelerations:** Presence ensures pH >7.20.
    4.  **Decelerations:**
...
* **Interpretation:**
    * **pH >7.25:** Normal.
    * **pH 7.20 – 7.25:** Borderline (Repeat in 30 mins).
    * **pH <7.20:** **Acidosis** $\rightarrow$ Immediate Delivery.
* *Note: Lactate measurement is an alternative to pH.*

## 5. SUMMARY ALGORITHM

1.  **High Risk Pregnancy** $\rightarrow$ Start NST/BPP/Doppler.
2.  **Labor Onset** $\rightarrow$ Continuous CTG (if high risk) or Intermittent Auscultation (low risk).
3.  **Abnormal CTG (Cat II)** $\rightarrow$ Scalp Stimulation.
    * *Reactive:* Continue monitoring.
    * *Non-reactive:* Scalp pH or Consider Delivery.
4.  **Category III CTG or pH <7.20** $\rightarrow$ **Expedite Delivery (C-Section/Instrumental).**