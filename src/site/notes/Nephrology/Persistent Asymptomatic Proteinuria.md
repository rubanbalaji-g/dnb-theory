...
- If the first-morning urine consistently demonstrates a dipstick reading of $\ge 1+$ (with specific gravity $>1.015$) or a urine PCR of $\ge 0.2$ mg/mg, the patient has fixed proteinuria and requires a comprehensive nephrological workup.
...
- If tubular proteinuria is suspected (e.g., male child with isolated proteinuria without hematuria), specific quantification of urinary LMW proteins ($\beta 2$-microglobulin) should be requested.
