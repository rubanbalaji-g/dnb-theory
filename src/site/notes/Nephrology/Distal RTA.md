---
{"dg-publish":true,"permalink":"/nephrology/distal-rta/","noteIcon":"","dgPassFrontmatter":true}
---
...
1. **H$^+$-ATPase and H$^+$/K$^+$ ATPase:** These pumps, located in the $\alpha$-intercalated cells of the cortical collecting ducts, secrete $\text{H}^+$ into the tubular lumen.
2. **Anion Exchanger 1 (AE1 or $\text{HCO}_3^-$/$\text{Cl}^-$ exchanger):** This protein, located on the basolateral membrane of the $\alpha$-intercalated cells, mediates the exit of bicarbonate ($\text{HCO}_3^-$) generated within the cell into the systemic circulation.
...
**Hypokalemia** is a classical, though variable, finding in dRTA. The mechanisms leading to potassium ($\text{K}^+$) wasting include:

- Increased urinary losses of $\text{K}^+$ and aldosterone stimulation due to urinary $\text{Na}^+$ loss and volume contraction.
- Failure of distal acid secretion, which creates an electrochemical gradient favoring potassium secretion.
- Compensatory overactivity of the $\text{H}^+$/$\text{K}^+$-ATPase in the collecting tubule.
- Impaired urinary concentrating ability and increased urinary flow rate activating $\text{K}^+$-secretion via BK-channels.

Severe hypokalemia can cause life-threatening complications, such as rhabdomyolysis and muscle paralysis, which may be a presenting sign of dRTA. Furthermore, $\text{Na}^+$ reabsorption may be impaired, resulting in **salt wasting**.
...
Genetic defects typically affect the AE1 exchanger or the $\text{H}^+$-ATPase pump subunits:
...
- **Autosomal Recessive (AR) dRTA:** Linked to mutations in the $\text{H}^+$-ATPase subunits, specifically the **ATP6V1B1** or **ATP6V0A4** genes.
- **dRTA with Deafness:** Associated with mutations in _ATP6V1B1_.
...
| :------------------------------------------ | :------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Plasma Potassium**                        | Normal or low              | High $\text{K}^+$ suggests Type 4 RTA.                                                                                                                                   |
...
| **$\mathbf{U-B}\ \mathbf{PCO_2}$ Gradient** | **Low (<10 mmHg)**         | Measured during passage of alkaline urine, reliable indicator of distal acidification failure.                                                                           |
...
1. **Treat Hypokalemia:** Hypokalemia should be corrected before addressing the acidosis.
2. **Alkali Supplementation:** Acidosis is treated by administering **sodium bicarbonate** or **sodium citrate** (Shohl solution), with doses titrated to blood bicarbonate levels.
    - The base requirement is typically in the range of $\mathbf{2-4\ mEq/kg/24\ hr}$.
...
3. **Managing Hypercalciuria:** Patients with symptomatic hypercalciuria, nephrocalcinosis, or nephrolithiasis may require **thiazide diuretics** to decrease urinary calcium excretion.
