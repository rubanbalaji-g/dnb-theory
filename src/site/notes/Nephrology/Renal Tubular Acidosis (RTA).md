...
- Proximal RTA is characterized by a reduced renal threshold for the reabsorption of bicarbonate in the proximal convoluted tubule. The threshold typically falls from a normal of 24-26 mmol/L down to 14-18 mEq/L.
...
- Type 3 RTA is an exceptionally rare autosomal recessive syndrome characterized by a combined pattern of proximal and distal tubular acidification defects.
- It is caused by pathogenic variants in the _CA2_ gene, which leads to a deficiency of the cytosolic enzyme Carbonic Anhydrase II, essential for generating carbonic acid from $CO_2$ and water in both the proximal and distal nephron segments.
- Patients classically present with osteopetrosis, cerebral calcifications, neurodevelopmental delay, paroxysmal muscle weakness, and growth retardation alongside the mixed RTA phenotype.
...
- The diagnostic approach initiates with a blood gas and basic metabolic panel to confirm the presence of a hyperchloremic, normal anion gap metabolic acidosis and to evaluate serum potassium concentrations.
- A meticulous clinical history must rule out extrarenal causes of bicarbonate loss, primarily severe diarrheal dehydration, which can mimic RTA.
- Urinalysis provides the foundational distinction between proximal and distal variants: a urine pH falling below 5.5 in the face of systemic acidosis points toward proximal RTA or Type 4 RTA, while a persistently alkaline urine pH (> 5.5 or > 6.0) strongly indicates distal RTA.
- Renal ultrasonography is mandatory to screen for structural anomalies, obstructive uropathy (Type 4 RTA), and to evaluate for nephrocalcinosis or nephrolithiasis (classic for distal RTA).
- Comprehensive audiometry and ophthalmologic examinations are recommended to identify sensorineural deafness or specific ocular findings (band keratopathy, cataracts) that aid in identifying the underlying genetic syndromic forms.
...
|**Urine-to-Blood $PCO_2$ ($U-B PCO_2$)**|> 20 mm Hg|< 10 mm Hg|> 20 mm Hg|
|**Urine Calcium Excretion**|Normal|High|Normal or Low|
|**Nephrocalcinosis**|Absent|Present|Absent|

- **Urine Anion Gap (UAG):** Calculated as ($U_{Na} + U_{K} - U_{Cl}$), the UAG acts as a surrogate marker for unmeasured urinary ammonium ($NH_4^+$). In distal RTA and Type 4 RTA, defective ammoniagenesis or secretion yields a positive UAG. Conversely, in proximal RTA or gastrointestinal bicarbonate losses, appropriate ammonium excretion results in a negative UAG.
- **Fractional Excretion of Bicarbonate:** Measured during a bicarbonate loading test. A massive fractional excretion (>10-15%) confirms the reduced proximal threshold seen in proximal RTA.
- **Urine-to-Blood $PCO_2$ Gradient:** Measured during the passage of highly alkaline urine (pH > 7.5). A gradient reduced below 10 mm Hg reliably indicates a profound failure of distal tubular acidification.
- **Stimulation Tests:** For patients with "incomplete" distal RTA (recurrent stone formers who lack overt systemic acidosis at baseline), provocative tests such as the short/long ammonium chloride acid-loading test or the furosemide + fludrocortisone test are utilized. Failure to drop the urine pH below 5.3 under these stimulated conditions confirms the defect.
...
- In contrast to proximal RTA, distal RTA is highly responsive to treatment. The therapeutic objective is to exactly match the daily endogenous acid load using relatively modest alkali supplementation, typically ranging between 2 to 4 mEq/kg/day.
- Potassium citrate is the preferred therapeutic agent, as it effectively normalizes the systemic acidosis while simultaneously correcting the characteristic hypokalemia and profound hypocitraturia, thereby dramatically reducing the risk of progressive nephrocalcinosis and urolithiasis.
- Sustained correction of the acidemia rapidly arrests the dissolution of bone buffers, normalizes urinary calcium excretion, and facilitates significant catch-up linear growth in affected children. Vitamin D supplements are generally not required for isolated distal RTA once the acidosis is corrected.
