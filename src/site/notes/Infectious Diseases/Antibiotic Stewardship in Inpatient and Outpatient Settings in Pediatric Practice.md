...
2. **Minimize Unintended Consequences:** Reducing the risk of adverse drug events, _Clostridioides difficile_ infections (CDI), and the emergence of antimicrobial resistance.
3. **Cost Effectiveness:** Reducing healthcare costs associated with unnecessary therapy.

It is critical to recognize that the goal is not merely to reduce antibiotic use, but to _optimize_ it; however, because inappropriate use is prevalent (estimated at 25–50% of prescriptions), optimization often leads to de-escalation or discontinuation of therapy.
...
- Antibiotics are the most common class of medications prescribed to pediatric outpatients.
- Over 50% of pediatric inpatients receive antibiotics during hospitalization.
- Approximately 25% to 50% of these prescriptions are inappropriate regarding drug choice, dose, or duration.
- **Irrational Therapy:** Common examples include using antibiotics for viral upper respiratory infections, prescribing broad-spectrum agents (e.g., carbapenems) for community-acquired infections, and using redundant combinations.
...
- **Definition:** Clinicians must obtain approval from the ASP team (ID physician or pharmacist) _before_ or shortly after prescribing restricted antimicrobials (usually broad-spectrum or expensive agents).
- **Pros:** Allows immediate optimization of therapy, prevents unnecessary initiation of broad-spectrum drugs, and prompts diagnostic counseling.
- **Cons:** Resource-intensive (requires real-time availability), potential delay in therapy, and perceived loss of prescriber autonomy.

#### B. Prospective Audit and Feedback (PAF) ("Back-End")

- **Definition:** The ASP team reviews antimicrobial orders after a set period (usually 48–72 hours). They then contact the prescriber to recommend de-escalation, discontinuation, or modification based on culture results and clinical status.
- **Pros:** Generally well-received by clinicians, preserves autonomy, allows review of more clinical data (cultures), and is flexible.
- **"Handshake Stewardship":** A specific form of PAF where recommendations are delivered face-to-face during rounds. This builds collaborative relationships and is highly effective.
...
- **Public Commitment:** Displaying posters in waiting rooms stating the clinic’s commitment to judicious antibiotic use can reduce unnecessary prescribing.
- **Communication Training:** Educating providers to provide "positive recommendations" (what _to_ do for symptoms) alongside "negative recommendations" (why antibiotics are _not_ needed) improves parental satisfaction without prescribing antibiotics.
...
- **Process Measures:**
    - **Days of Therapy (DOT):** The preferred inpatient metric, defined as the number of days a patient receives an antimicrobial (normalized per 1,000 patient days).
    - **Outpatient Metrics:** Proportion of visits for ARIs resulting in an antibiotic prescription, or the percentage of broad-spectrum vs. narrow-spectrum agents used.
- **Outcome Measures:**
    - Reductions in _C. difficile_ infection rates.
    - Reductions in antimicrobial resistance rates (though this takes time to manifest).
    - Cost savings (drug acquisition and administration costs).
    - Clinical outcomes (readmissions, length of stay, mortality) to ensure stewardship is safe.

## 8. Conclusion

Antibiotic stewardship in pediatrics is a patient safety imperative. In both inpatient and outpatient settings, it requires a shift from "just in case" prescribing to "evidence-based" optimization. By employing strategies like preauthorization, prospective audit and feedback, and delayed prescribing, pediatricians can effectively combat the global threat of antimicrobial resistance while ensuring the safety and recovery of their individual patients. The success of these programs relies on multidisciplinary collaboration, education, and a commitment to rational therapeutic principles.