...
- **Respiratory Syncytial Virus (RSV):**
    - _Palivizumab:_ A monoclonal antibody used for prophylaxis in high-risk infants (prematurity, chronic lung disease, congenital heart disease).
    - _Nirsevimab:_ A newer long-acting monoclonal antibody recommended for all infants entering their first RSV season.
- **Hepatitis B:**
    - _HBIG:_ Administered to neonates born to HBsAg-positive mothers (along with the Hep B vaccine) within 12 hours of birth to prevent perinatal transmission.
