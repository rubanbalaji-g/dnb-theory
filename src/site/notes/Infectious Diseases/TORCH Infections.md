---
{"dg-publish":true,"permalink":"/infectious-diseases/torch-infections/"}
---
...
- **Agent:** _Toxoplasma gondii_, an obligate intracellular protozoan.
...
- **Fetal Diagnosis:** PCR for _T. gondii_ in amniotic fluid (performed >18 weeks gestation).
- **Neonatal Diagnosis:**
...
- **Targeted Approach:** Investigations should be guided by specific clinical findings:
    - _Cataracts/CHD:_ Suspect Rubella.
    - _Calcifications:_ Periventricular (CMV) vs Diffuse (Toxo).
    - _Snuffles/Bone lesions:_ Suspect Syphilis.
    - _Vesicles:_ Suspect HSV.
- **Preferred Tests:**
