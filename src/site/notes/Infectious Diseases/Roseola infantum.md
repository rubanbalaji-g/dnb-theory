...
The illness typically begins abruptly with a **high fever**, often ranging from 38.5°C to 40°C (101.3°F to 104°F).
...
- **Morphology:** The rash consists of discrete, rose-colored or pink **macules and papules** (2–3 mm in diameter) that blanch on pressure.
...
- **Measles:** Distinguished by the presence of significant cough, coryza, conjunctivitis, Koplik spots, and a rash that appears _at the height_ of the fever, not after it subsides.
