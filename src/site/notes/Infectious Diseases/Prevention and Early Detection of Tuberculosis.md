---
{"dg-publish":true,"uplink":"/infectious-diseases/infectious-diseases/","uptext":"Back to Index (Infectious Diseases)","permalink":"/infectious-diseases/prevention-and-early-detection-of-tuberculosis/","dgPassFrontmatter":true}
---
...
Bacille Calmette-Guérin (BCG) is a live attenuated vaccine derived from _Mycobacterium bovis_.
...
2. **Upfront Molecular Testing (The Game Changer):**
    ...
    - **NAAT (Nucleic Acid Amplification Test):** Tests like **CBNAAT (GeneXpert)** or **TrueNat** are now the primary diagnostic tools for children. They detect _M. tuberculosis_ and Rifampicin resistance simultaneously within hours.
