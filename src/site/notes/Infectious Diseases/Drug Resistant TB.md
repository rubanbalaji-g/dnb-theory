---
{"dg-publish":true,"uplink":"/infectious-diseases/infectious-diseases/","uptext":"Back to Index (Infectious Diseases)","permalink":"/infectious-diseases/drug-resistant-tb/","dgPassFrontmatter":true}
---
...
4. Non-response or failure of a first-line regimen. _Management:_ These children are treated according to the resistance pattern of the source case after approval by the Nodal DR-TB Committee.
...
- **Mechanism:** It is a diarylquinoline that specifically inhibits mycobacterial ATP synthase, an enzyme essential for energy supply to _M. tuberculosis_. It is bactericidal and has sterilizing activity.
...
- **Linezolid (Lzd):** An oxazolidinone inhibiting protein synthesis.
    - _Role:_ Core Group A drug.
    - _Toxicity:_ Bone marrow suppression (anemia, thrombocytopenia) and peripheral/optic neuropathy. Dose tapering is often required.
...
- **Regimen Structure:**
    ...
    - _Note:_ Bedaquiline is given for 6 months.
...
- **Regimen Design:**
    ...
    - _Standard composition:_ Lfx/Mfx, Lzd, Cfz, Cs, (+ Bdq if >5y).
