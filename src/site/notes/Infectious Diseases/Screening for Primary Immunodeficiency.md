---
{"dg-publish":true,"uptext":"Back to Index (🦠 Infectious Diseases)","uplink":"/infectious-diseases/infectious-diseases/","permalink":"/infectious-diseases/screening-for-primary-immunodeficiency/","dgPassFrontmatter":true}
---
...
- **Screening for Phagocyte Defects:**
    - The dihydrorhodamine (DHR) reduction assay by flow cytometry or the nitroblue tetrazolium (NBT) slide test is employed to evaluate the neutrophil oxidative burst, serving as the primary screen for [[Infectious Diseases/Chronic Granulomatous Disease (CGD)\|chronic granulomatous disease (CGD)]].
