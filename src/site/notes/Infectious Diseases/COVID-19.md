---
{"dg-publish":true,"uplink":"/infectious-diseases/infectious-diseases/","uptext":"Back to Index (Infectious Diseases)","permalink":"/infectious-diseases/covid-19/","dgPassFrontmatter":true}
---

## Introduction

- Coronavirus disease 2019 ([[Infectious Diseases/COVID-19\|COVID-19]]), caused by the severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2), presents a diverse clinical spectrum in the pediatric population. 
- While initial epidemiological data suggested children were relatively spared from severe disease compared to adults, the evolution of the pandemic, emergence of variants (Delta, Omicron), and identification of post-infectious hyperinflammatory syndromes have reshaped the understanding of pediatric [[Infectious Diseases/COVID-19\|COVID-19]]. 
...
- **Global and Regional Trends** 
	- Historically, children accounted for a small proportion of total [[Infectious Diseases/COVID-19\|COVID-19]] cases early in the pandemic. 
	- However, surveillance data from the United States indicates that children made up approximately 18% of all reported [[Infectious Diseases/COVID-19\|COVID-19]] cases between 2020 and 2023. 
...
- **Age-Specific Susceptibility** 
	...
	- Surveillance data from 2024–2025 reveals that children under 2 years accounted for the largest share (54%) of pediatric [[Infectious Diseases/COVID-19\|COVID-19]] deaths and 57% of hospitalizations. 
...
## Pathophysiology of [[Infectious Diseases/COVID-19\|COVID-19]]

- The pathophysiology of Coronavirus Disease 2019 ([[Infectious Diseases/COVID-19\|COVID-19]]), caused by the severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2), involves a complex interplay between viral replication, host immune responses, and subsequent systemic inflammation. 
- The disease spectrum ranges from asymptomatic or mild respiratory symptoms to severe pneumonia, acute [[Neonatalogy/Respiratory Distress Syndrome\|respiratory distress syndrome]] (ARDS), and multiorgan failure. 
...
The initial step in the pathogenesis of [[Infectious Diseases/COVID-19\|COVID-19]] is the entry of SARS-CoV-2 into host cells.
...
- **Consequences of Hyperinflammation:** This uncontrolled inflammation leads to diffuse alveolar damage, endothelial injury, and multiorgan dysfunction. The cytokine storm is a central mechanism in the progression to ARDS and septic shock in critical [[Infectious Diseases/COVID-19\|COVID-19]].

### 3. Endothelial Dysfunction and Coagulopathy

A hallmark of severe [[Infectious Diseases/COVID-19\|COVID-19]] is endotheliitis (inflammation of the blood vessels) and a prothrombotic state.
...
Children generally experience milder acute [[Infectious Diseases/COVID-19\|COVID-19]] than adults. Several physiological factors contribute to this "pediatric protection":
...
MIS-C is a severe hyperinflammatory condition that typically occurs 2–6 weeks after acute SARS-CoV-2 infection. It is distinct from acute [[Infectious Diseases/COVID-19\|COVID-19]] and is believed to be driven by post-infectious immune dysregulation rather than direct viral replication.
...
- **Specific Cytokine Signatures:** MIS-C is characterized by a specific inflammatory signature, including elevated IFN-γ and CXCL9, suggesting a distinct cytokine amplification loop compared to acute [[Infectious Diseases/COVID-19\|COVID-19]]. Activation of CX3CR1+ CD8+ T-cells has been linked to vascular complications.

### 6. Pathophysiology of Multisystem Inflammatory Syndrome in Neonates (MIS-N)

MIS-N is a rare condition observed in neonates born to mothers with [[Infectious Diseases/COVID-19\|COVID-19]] during pregnancy. Its pathophysiology differs from MIS-C in the source of the immune trigger.
...
According to the Ministry of Health and Family Welfare (MoHFW) and Indian Academy of Pediatrics (IAP) guidelines, pediatric [[Infectious Diseases/COVID-19\|COVID-19]] is categorized based on respiratory status and saturation.
...
- **Definition:** Patients with upper respiratory tract symptoms (sore throat, rhinorrhea, cough) without fast breathing or hypoxia ( $SpO_2 \ge 94\%$ on room air).
...
- **Definition:** Presence of pneumonia with rapid respiration for age or $SpO_2$ between 90–93% on room air.
...
- **Management:** Hospital admission is recommended for monitoring. Supportive care includes oxygen therapy to maintain $SpO_2 > 94\%$, fluid/electrolyte balance, and antibiotics only if bacterial superinfection is suspected.

#### 4. Severe Illness

- **Definition:** Severe pneumonia, Acute [[Neonatalogy/Respiratory Distress Syndrome\|Respiratory Distress Syndrome]] (ARDS), Septic Shock, or $SpO_2 < 90\%$ on room air.
...
MIS-C is a severe, post-infectious hyperinflammatory condition occurring 2–6 weeks after SARS-CoV-2 infection. It shares features with [[Rheumatology/Kawasaki Disease\|Kawasaki Disease]] (KD) and [[Infectious Diseases/Toxic Shock Syndrome (TSS)\|Toxic Shock Syndrome (TSS)]] but has distinct epidemiology and pathophysiology.
...
- **Cardiovascular:** Occurs in 60-80% of cases. Manifestations include myocarditis, [[Cardiology/Pericarditis\|pericarditis]], ventricular dysfunction, and coronary artery dilation/aneurysms. Shock is a distinguishing feature from classic [[Rheumatology/Kawasaki Disease\|Kawasaki Disease]].
...
**Pathogenesis:** MIS-N is believed to result from the transplacental transfer of maternal SARS-CoV-2 IgG antibodies or inflammatory cytokines, triggering immune activation in the fetus/neonate. Alternatively, it may result from endogenous antibody production if the fetus was infected _in utero_ .
...
- **Viral Detection:** [[Genetics/NAAT\|NAAT]] (RT-PCR) is the gold standard for acute infection. Antigen tests have lower sensitivity but are useful for rapid screening.
...
## Management of [[Infectious Diseases/COVID-19\|COVID-19]] Infections in Children
### Management of Acute [[Infectious Diseases/COVID-19\|COVID-19]]
...
- **High-Risk Children:** Children with comorbidities (congenital heart disease, [[Respiratory/Chronic Lung Disease\|chronic lung disease]], immunocompromised state, obesity) with mild symptoms may require close monitoring or admission if home monitoring is not feasible.

#### 2. Moderate Disease (Ward/HDU Admission)

- **Oxygen Therapy:** Initiate oxygen if $SpO_2 < 94\%$ to maintain target saturation between 94–96%.
...
- **Corticosteroids:** Not routinely required for all moderate cases. They may be administered in rapidly progressive disease.
    - _Drug:_ Dexamethasone 0.15 mg/kg/dose (max 6 mg) once daily or Methylprednisolone 0.75 mg/kg/dose.
...
- **Respiratory Support:**
    - **Oxygen:** Immediate supplementation to maintain $SpO_2 > 94\%$.
...
- **Corticosteroids:** Strongly recommended for severe illness.
    - _Dose:_ Intravenous Dexamethasone 0.15 mg/kg/dose (max 6 mg) twice daily or Methylprednisolone 1–2 mg/kg/day for 5–14 days. Taper over 10–14 days depending on clinical improvement.
...
**Diagnostic Criteria (WHO/CDC):** Fever >3 days in a child 0–19 years AND two of: (a) Rash/conjunctivitis/mucocutaneous signs, (b) Hypotension/shock, (c) Cardiac dysfunction/coronary abnormalities, (d) Coagulopathy, (e) Acute GI symptoms; AND elevated inflammatory markers (CRP, ESR, Procalcitonin); AND evidence of [[Infectious Diseases/COVID-19\|COVID-19]] (PCR, antigen, or serology) with exclusion of other causes (sepsis, tropical fevers).
...
1. **First-Line Immunomodulation:**
    ...
    - _Note:_ Recent evidence supports combining IVIG and steroids upfront for moderate-severe cases (shock, cardiac involvement) to reduce treatment failure and ICU stay.
2. **Refractory Disease:**
    ...
    - **Biologics:** In cases refractory to steroids and IVIG, cytokine blockers may be considered after expert consultation.
        - _Anakinra_ (IL-1 receptor antagonist): Often the first-choice biologic (2–10 mg/kg/day).
        - _Tocilizumab_ (IL-6 inhibitor): Alternative for specific phenotypes.
        - _Infliximab_ (TNF-alpha inhibitor).
...
- **Suspicion:** Neonates with respiratory distress, shock, or cardiac dysfunction born to mothers with [[Infectious Diseases/COVID-19\|COVID-19]] history and positive IgG antibodies.
...
Children with moderate-severe [[Infectious Diseases/COVID-19\|COVID-19]] or MIS-C require follow-up.
...
|:--|:--|:--|
|**Paracetamol**|10–15 mg/kg/dose q4-6h|Fever/Pain (Mild-Severe)|
|**Dexamethasone**|0.15 mg/kg/dose BD (Max 6mg)|Severe/Critical [[Infectious Diseases/COVID-19\|COVID-19]]|
|**Methylprednisolone**|1–2 mg/kg/day|MIS-C (First line), Moderate [[Infectious Diseases/COVID-19\|COVID-19]]|
|**Pulse Steroids**|10–30 mg/kg/day x 3 days|Refractory MIS-C|
|**IVIG**|2 g/kg over 12–24h|MIS-C, Severe MIS-N|
|**Aspirin**|3–5 mg/kg/day|MIS-C (Antiplatelet)|
