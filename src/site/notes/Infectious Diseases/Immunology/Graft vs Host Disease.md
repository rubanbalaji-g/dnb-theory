---
{"dg-publish":true,"uptext":"Back to Index (🦠 Infectious Diseases)","uplink":"/infectious-diseases/infectious-diseases/","permalink":"/infectious-diseases/immunology/graft-vs-host-disease/","dgPassFrontmatter":true}
---

## Pathogenesis and Prerequisites of Graft-Versus-Host Disease
...
- In the second step, donor T cells become activated in response to these recipient antigens, leading them to proliferate, expand, and generate high levels of cytokines, notably tumor necrosis factor (TNF)-$\alpha$, IL-2, and interferon (IFN)-$\gamma$.
...
- Selective graft manipulation techniques are increasingly employed, specifically targeting the depletion of $\alpha/\beta$ T cells (which mediate GVHD) while preserving $\gamma/\delta$ T cells to maintain graft-versus-leukemia (GVL) effects and infectious immunity.
...
- Pharmacologic treatments for steroid-resistant acute GVHD include ruxolitinib (targeting the JAK signaling pathway), infliximab and etanercept (targeting TNF), vedolizumab (targeting $\alpha_4\beta_7$-integrin), and tocilizumab (targeting IL-6).
...
- Gastrointestinal and systemic symptoms include failure to thrive, malabsorption, [[Gastrointestinal/Chronic Diarrhea\|chronic diarrhea]], esophageal strictures, and profound immunodeficiency predisposing to recurrent infections,.
...
- GVHD can be iatrogenically induced when profoundly immunodeficient patients, such as infants with [[Infectious Diseases/Immunology/Severe Combined Immunodeficiency (SCID)\|Severe Combined Immunodeficiency (SCID)]], receive unirradiated blood transfusions.
