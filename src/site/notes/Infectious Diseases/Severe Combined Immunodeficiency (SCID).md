---
{"dg-publish":true,"uptext":"Back to Index (🦠 Infectious Diseases)","uplink":"/infectious-diseases/infectious-diseases/","permalink":"/infectious-diseases/severe-combined-immunodeficiency-scid/","dgPassFrontmatter":true}
---
...
- **T- B+ SCID (T-cell absent, B-cell present):**
    - The most common form is X-linked SCID, caused by pathogenic variants in the _IL2RG_ gene (CD132) encoding the common gamma chain ($γc$) of cytokine receptors (IL-2, IL-4, IL-7, IL-9, IL-15, and IL-21).
    ...
    - Pathogenic variants in _JAK3_, which signals downstream of the common gamma chain, cause an autosomal recessive form of SCID that presents with an identical lymphocyte phenotype (T- B+ NK-) affecting both males and females.
    - _IL-7Rα_ deficiency, CD45 deficiency, and CD3 deficiencies (arrest of thymocyte differentiation) also cause T- B+ forms of SCID.
