---
{"dg-publish":true,"uptext":"Back to Index (🧬 Genetics)","uplink":"/genetics/genetics/","permalink":"/genetics/mutations-and-their-consequences/","dgPassFrontmatter":true}
---
...
|Dynamic Mutations|Triplet Repeat Expansions|Nucleotide repeats expand in successive generations causing anticipation, such as [[Genetics/Fragile X Syndrome\|Fragile X syndrome]] (CGG) or Myotonic Dystrophy (CTG).|
...
- **Genomic Instability:** Defects in DNA repair pathways precipitate chromosomal instability and increase oncogenic risk, characteristically found in [[Hematology/Fanconi Anemia\|Fanconi anemia]].
...
- **Disease Surveillance:** Prognosis is highly variable, ranging from treatable conditions like [[Metabolic Disorders/Phenylketonuria\|phenylketonuria]], which responds to dietary compliance, to uniformly fatal conditions like untreated Pompe disease. Long-term surveillance is mandatory, incorporating growth, developmental, cardiac, and ophthalmic screening. Cancer surveillance protocols, such as annual MRI, are critical for predisposition syndromes like Li-Fraumeni.
- **Diagnostic Interventions:** Early diagnosis via [[neonatalogy/Newborn Screening\|newborn screening]] dramatically improves outcomes for metabolic conditions such as [[Endocrinology/Congenital Hypothyroidism\|congenital hypothyroidism]] and medium-chain acyl-CoA dehydrogenase (MCAD) deficiency.
