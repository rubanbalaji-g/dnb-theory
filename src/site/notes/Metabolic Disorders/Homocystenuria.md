---
{"dg-publish":true,"uplink":"/metabolic-disorders","uptext":"Back to Index (Metabolic Disorders)","permalink":"/metabolic-disorders/homocystenuria/","dgPassFrontmatter":true}
---
...
* **Classic Homocystinuria:** Due to deficiency of **Cystathionine $\beta$-Synthase (CBS)**.
* **Other Forms:** Defects in homocysteine remethylation (e.g., MTHFR deficiency, Cobalamin defects).

## Etiology and Pathophysiology
**1. Classic Homocystinuria (CBS Deficiency)**
* **Enzyme:** Cystathionine $\beta$-Synthase (Requires **Vitamin B6/Pyridoxine** as cofactor).
* **Pathway:** Transsulfuration pathway (Methionine $\rightarrow$ Homocysteine $\rightarrow$ Cystathionine $\rightarrow$ Cysteine).
* **Biochemical Defect:** Block in conversion of Homocysteine to Cystathionine.
* **Consequences:**
...
![](https://i.ibb.co/j9MNc06H/image.png)
...
* **Ectopia Lentis (Lens Dislocation):**
    ...
    * Onset: Usually by 3–4 years; almost all by 10 years.
...
* **Intellectual Disability:** Common (IQ 30–75) but variable; B6-responsive patients often have normal IQ.
...
* **Plasma Total Homocysteine (tHcy):** Markedly elevated (>100 µmol/L; Normal <15).
...
* **Method:** Give 100–500 mg Vitamin B6 daily.
...
* **Vitamin B6 (Pyridoxine):** High dose (200–500 mg/day).
* **Goal:** Maintain plasma Hcy <50 µmol/L.
...
* **Betaine (Trimethylglycine):**
    ...
    * **Risk:** Can excessively raise Methionine levels (monitor for cerebral edema risk if Met >1000 µmol/L).
