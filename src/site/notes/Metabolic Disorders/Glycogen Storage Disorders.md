---
{"dg-publish":true,"permalink":"/metabolic-disorders/glycogen-storage-disorders/"}
---
...
* **Pathophysiology**:
    * Inability to convert G6P $\rightarrow$ Glucose.
    * **Metabolic Shunting**: Excess G6P shunted to:
        * Glycolysis $\rightarrow$ **Lactic Acidosis**.
        * Lipogenesis $\rightarrow$ **Hypertriglyceridemia** (VLDL).
        * Pentose Phosphate Pathway $\rightarrow$ Uric acid $\rightarrow$ **Hyperuricemia**.
* **Clinical Features**:
    ...
    * **GSD Ib Specifics**: Neutropenia, neutrophil dysfunction $\rightarrow$ Recurrent infections, Inflammatory Bowel Disease (Crohn-like).
* **Biochemistry**:
...
* **Pathology**: Accumulation of unbranched, insoluble glycogen ("Polyglucosan bodies") $\rightarrow$ acts as foreign body $\rightarrow$ intense fibrosis.
* **Clinical**:
...
* **Pathophysiology**: Inability to synthesize glycogen $\rightarrow$ No hepatic stores.
* **Clinical**:
