...
- Continuum of care from community to [[Social Pediatics/District Early Intervention Centre (DEIC)\|District Early Intervention Centre (DEIC)]] to tertiary level
...
2. **[[Nutrition/Vitamin A\|Vitamin A]] Deficiency** (Bitot's Spot) 
...
1. **Skin conditions** ([[Misc/Scabies\|Scabies]], Fungal Infection, and Eczema) 
2. **Otitis Media** 
3. **Rheumatic Heart Disease** 
4. **Reactive Airway Disease** (e.g., [[Respiratory/Asthma\|Asthma]]) 
5. **Dental Caries** 
...
8. **Learning Disorder** 
9. **Attention Deficit Hyperactivity Disorder ([[Development/ADHD\|ADHD]])**
