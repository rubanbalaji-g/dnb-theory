...
1. **Integration:** Seamlessly aligning newborn health with maternal, child, and adolescent health programs (RMNCH+A) along the continuum of care.
2. **Equity:** Prioritizing the most marginalized, remote, and vulnerable populations to eliminate geographical and socio-economic disparities.
3. **Gender:** Ensuring strict gender parity in care-seeking behavior and newborn survival interventions.
4. **Quality of Care:** Mandating evidence-based, timely, safe, and respectful care at all health facility levels.
5. **Convergence:** Emphasizing multi-sectoral coordination (e.g., sanitation, nutrition, women and child development).
6. **Accountability:** Tracking programmatic progress through robust data metrics and Maternal Perinatal Death Surveillance and Response (MPDSR).
7. **Partnerships:** Engaging the private sector, NGOs, and professional bodies (e.g., Indian Academy of Pediatrics, National Neonatology Forum).
