---
{"dg-publish":true,"uptext":"Back to Index (⭕ Misc)","uplink":"/misc/miscellaneous-topics/","permalink":"/misc/open-vial-policy/","dgPassFrontmatter":true}
---
...
* **Labeling Protocol:** The vaccinator must explicitly record the date and time of the initial opening directly on the vial label immediately upon puncturing the septum.
* **Aseptic Technique:** All individual doses must be withdrawn utilizing a sterile, new Auto-Disable (AD) syringe and needle.
* **Septum Protocol:** The needle must never be left inserted in the septum after withdrawing a dose, as this breaches the sterile seal.
* **Storage and Hierarchy:** Opened, OVP-compliant vials must be returned to the Ice-Lined Refrigerator (ILR) or vaccine carrier immediately following the session. They should be stored in the designated "Use First" box within the ILR.
* **Prioritization:** Opened vials retrieved from previous sessions must be utilized completely before initiating a new vial of the identical vaccine.
