---
{"dg-publish":true,"uptext":"Back to Index (🔬Recent Advances)","uplink":"/Recents/recents/","dg-path":"Recents/PALICC2-updates","permalink":"/recents/palicc-2-updates/","dgPassFrontmatter":true}
---
...
|Ventilation Parameter|PALICC-2 Recommendation|
|:--|:--|
|**Tidal Volume**|4 to 8 mL/kg of predicted body weight (PBW).|
|**Plateau Pressure**|Maintained at $\le$ 28 cmH2O.|
|**Driving Pressure**|Targeted to remain < 15 cmH2O to actively minimize ventilator-induced lung injury.|
|**PEEP Titration**|Titrated carefully according to established lower/higher PEEP tables.|
|**Gas Exchange**|Permissive hypercapnia is recommended.|
