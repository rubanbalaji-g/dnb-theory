---
{"dg-publish":true,"uptext":"Back to Index (🔬Recent Advances)","uplink":"/Recents/recents/","dg-path":"Recents/antibiotic-stewardship","permalink":"/recents/antibiotic-stewardship/","dgPassFrontmatter":true}
---
...
|Core Element|Intervention Strategy|
|:--|:--|
...
|**Formulary Restriction**|Preauthorization is mandated for WHO "Reserve" category antibiotics (e.g., Colistin, Cefiderocol, Ceftazidime-avibactam) to restrict use to confirmed multi-drug resistant infections.|
|**Tracking And Reporting**|Tracking standardizes consumption data using "Days of Therapy" (DOT) per 1000 patient days to benchmark across PICUs and NICUs.|
