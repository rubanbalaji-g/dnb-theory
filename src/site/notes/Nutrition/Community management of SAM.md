---
{"dg-publish":true,"permalink":"/nutrition/community-management-of-sam/"}
---
...
- **Diagnostic Criteria for SAM (6–59 months):**
    
    - Weight-for-height/length < -3 SD (WHO Standards).
    - Mid-Upper Arm Circumference (MUAC) < 11.5 cm.
    - Bilateral pitting oedema.
- **Criteria for Community/Home-Based Care (Uncomplicated SAM):** A child qualifies for home management if they meet **all** of the following conditions:
...
- **Dietary Sources:**
    ...
    - **Frequency:** Feeds should be given **6–8 times a day**.
...
- **Structured Play:** Encourage play therapy for 15–30 minutes daily using simple local toys to reverse developmental delay.
...
- **Weight Gain:** Achieved weight gain of ≥15% and satisfactory gain (>5 g/kg/day) for 3 consecutive days.
...
2. **Check for Complications:**
    - _Complications present / Failed Appetite Test / Severe Oedema_ $\rightarrow$ **Inpatient Care (Facility)**.
    - _No Complications + Good Appetite + Alert_ $\rightarrow$ **Outpatient/Home Care (Community)**.