---
{"dg-publish":true,"permalink":"/nutrition/parameters-to-detect-undernutrition/"}
---
...
- **Method:** Recumbent length is measured for children < 2 years (or < 87 cm). Standing height is measured for children $\ge$ 2 years.
- **Height-for-Age (HFA):**
...
_Note: If edema is present, letter 'K' is added (e.g., Grade III K)._
