---
{"dg-publish":true,"uplink":"/nutrition/nutrition/","uptext":"Back to Index (Nutrition)","permalink":"/nutrition/nutritional-support-of-a-critically-ill-child/","dgPassFrontmatter":true}
---
...
- **Physiological Response to Stress:**
    - **Hypermetabolism:** Energy expenditure may increase to 120–250% of normal in conditions like head injury or sepsis.
...
- **Calculation Methods:**
    - **Holliday and Segar Formula:** Used for maintenance calorie and fluid estimation based on weight.
        - 0–10 kg: 100 kcal/kg.
        - 10–20 kg: 1000 kcal + 50 kcal/kg for every kg >10.
        - > 20 kg: 1500 kcal + 20 kcal/kg for every kg >20.
            
    - **Therapeutic Calculation:** In hospital settings, 150–200 kcal/kg (based on observed weight) is often targeted for malnutrition recovery.
...
- **Proteins:**
    - Standard requirement: 1.5–2 g/kg/day.
    - Hypercatabolic states/Malnutrition: May require up to 3–4 g/kg/day.
    - Renal Failure: Restrict to 0.25–0.5 g/kg/day to prevent azotemia.
- **Carbohydrates:**
    - Should provide 50–60% of total calories.
    - Glucose infusion rates of 6–12 mg/kg/min are typically tolerated; higher rates may cause fatty liver.
- **Fats:**
    - Provide 25–45% of calories.
...
- Requirements for vitamins and minerals (e.g., Zinc, Iron, B-complex) increase 5–10 times during illness due to excessive losses and increased metabolic demand.
...
- **Isodense Formulas:** Supply 100 kcal/100 mL (1 kcal/mL). Can be prepared by adding sugar and oil to milk.
    - _High Energy Milk:_ 100 mL milk + 1 tsp sugar + 1/2 tsp oil.
    - _Cereal-Pulse Mix:_ Precooked mixes (e.g., SAT mix) can be dissolved to provide calorie-dense feeds.
- **Therapeutic Diets:**
...
- **Composition Guidelines:**
    ...
    - **Glucose:** 15–30 g/kg/day. Start at 6 mg/kg/min and increase slowly.
    - **Proteins:** Crystalline amino acids (e.g., Aminosyn, Vamin). Dose: 2–3 g/kg/day.
    - **Lipids:** 20% Intralipid (soybean/safflower oil). Essential to prevent Essential Fatty Acid deficiency. Dose: 1–3 g/kg/day.
...
- **Fluid:** Restrict to Insensible Water Loss (IWL) + Urine Output.
    - IWL: ~400 mL/m²/day or 30 mL/kg (infants) to 10 mL/kg (adults).
- **Protein:** Restrict to 0.5–1.25 g/kg/day to minimize azotemia.
...
1. **Stabilize:** Secure Airway, Breathing, Circulation. Correct Hypoglycemia/Electrolytes.
2. **Calculate:** Fluid needs (maintenance vs. restriction) and Caloric needs (BMR + stress factor).
3. **Choose Route:** Oral > NG > Peripheral Parenteral > Central Parenteral.
4. **Select Feed:** Age-appropriate, isodense (1 kcal/mL) if fluid restricted, specialized for organ failure.
5. **Monitor:** Weight, hydration status, abdominal girth, residuals, and biochemistry daily.