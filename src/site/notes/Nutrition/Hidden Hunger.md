---
{"dg-publish":true,"uplink":"/nutrition/nutrition/","uptext":"Back to Index (Nutrition)","permalink":"/nutrition/hidden-hunger/","dgPassFrontmatter":true}
---
...
- It is considered a major component of the **"Triple Burden of Malnutrition"** (alongside undernutrition and obesity),.
...
- **Bioavailability Issues:**
    ...
    - Excessive intake of cow’s milk can hinder iron and calcium absorption due to high phosphate content,.
- **Losses and Increased Demand:**
    - Recurrent infections (diarrhea, pneumonia) deplete micronutrient stores,.
...
- **Prevalence:** It is the most common micronutrient deficiency globally and in India,. NFHS-5 data indicates 67% of children (6-59 months) are anemic,.
- **Impact:**
    - Leading cause of nutritional anemia.
    - impairs physical stamina, concentration, and work efficiency.
    - Lowers IQ by approximately 9 points and causes irreversible changes in brain dopamine receptors,.
    - Contributes to 20% of maternal deaths.
- **Sources:** Heme iron (liver, meat) is better absorbed than non-heme iron (greens, jaggery, dates),.
...
- **Impact:**
    ...
    - Reduces epithelial integrity and immunity, increasing morbidity and mortality from diarrhea and measles,.
- **Clinical Features:** Night blindness, Bitot’s spots, corneal xerosis, and keratomalacia.
- **Epidemiology:** Continues to be a public health problem in backward pockets, although florid deficiency is declining.
...
### 1. Dietary Diversification (Long-term Strategy)

- **Rainbow Revolution:** Encouraging the consumption of "GYOR" foods (Green, Yellow, Orange, Red vegetables and fruits) to ensure adequate intake of antioxidants and vitamins,.
...
- **Universal Salt Iodization (USI):** Fortifying salt with potassium iodate (minimum 15 ppm at consumer level) is the most successful intervention for IDD,.
- **Double Fortified Salt:** Salt fortified with both Iron and Iodine to tackle two major deficiencies simultaneously,.
- **Biofortification:** Breeding crops with higher nutrient levels (e.g., iron-rich pearl millet, carotene-rich sweet potato),.
