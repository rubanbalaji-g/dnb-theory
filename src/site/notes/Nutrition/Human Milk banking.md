---
{"dg-publish":true,"permalink":"/nutrition/human-milk-banking/"}
---
...
- **Hierarchy of Feeding Choices:** For preterm and LBW babies, the order of preference for milk is:
    ...
    2. **Banked human milk**.
    3. Standard infant formula (least preferred due to higher risk of complications like NEC).
...
3. **Action:**
    - Press the thumb and finger slightly _inwards_ towards the chest wall.
    - Press the breast tissue _behind_ the nipple and areola between the finger and thumb (compressing the lactiferous sinuses).
...
- **Room Temperature:** Expressed Breast Milk (EBM) can be kept for **4 hours** to **8 hours**.
    - _Note:_ Sources vary slightly; strict banking usually adheres to the shorter duration (4 hours), while domestic guidelines may allow up to 8 hours depending on ambient temperature.
- **Refrigerator (4°C):**
    - Safe for **24 hours**.
