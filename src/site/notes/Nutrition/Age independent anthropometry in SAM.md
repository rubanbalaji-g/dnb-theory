---
{"dg-publish":true,"uplink":"/nutrition/nutrition/","uptext":"Back to Index (Nutrition)","tags":null,"permalink":"/nutrition/age-independent-anthropometry-in-sam/","dgPassFrontmatter":true}
---
...
- **Method:**
    1. Locate the midpoint of the left upper arm between the tip of the shoulder (acromion) and the tip of the elbow (olecranon) with the arm flexed at 90 degrees.
    2Index Measure the circumference at this point with the arm hanging loosely at the side.
    2. Use a non-stretchable tape or a specific tri-colored MUAC tape (Shakir’s tape).
...
- **Principle:** Measures sIndex calorie reserve. Malnutrition depletes fat stores.
...
2. **Rao and Singh Index $$\frac{ \text{Weight (kg)}} {\text {Height (cm)}^2}$$
    - **Interpretation:**
        - > 0.0015: Normal.
...
3. **Kanawati and McLaren Index (MUAC/Head Circumference Ratio):**
    ...
    - **CalculationIndex m) / Head Circumference (cm).
    - **Interpretation:**
        - > 0.31: Normal.
        - 0.28 – 0.31: Mild Malnutrition.
        - 0.25 – 0.28: Moderate Malnutrition.
        - < 0.25: Severe Malnutrition.
4. **Dugdale's Index:**$$\frac{ \text{Weight (kg)}} {\text {Height (cm)}^{1.6}}$$
...
- Index  of fluid in tissues, a hallmark of Kwashiorkor.
- **Method:** Apply gentle thumb pressure on the _dorsum of both feet_ for 3–10 seconds. If a pit (dent) remains after releasing, oedema is present.
- **Grading:**
    - **+ (Mild):** Both feet.
    - **++ (Moderate):*Index 
    - **+++ (SevIndex egs, hands, arms, face).
...
#### C. CutaIndex 
- **Hair:**
    - **HypIndex gment (brown/reddish hair).
...
- **[[Nutrition/Vitamin A\|Vitamin A]]:** Night blindness, Bitot’s spots, corneal xerosis/ulceration.
...
- **Developmental Milestones:**
    ...
    - _Note:_ Malnutrition delays these milestones, so this method may underestimate age (making the child appear younger and potentially better nourished on charts than they actually are).
