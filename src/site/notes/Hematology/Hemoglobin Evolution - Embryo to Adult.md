---
{"dg-publish":true,"uptext":"Back to Index(🩸 Hematology and Oncology)","uplink":"/hematology/hematology/","permalink":"/hematology/hemoglobin-evolution-embryo-to-adult/","dgPassFrontmatter":true}
---

## Genetic Organization

- Hemoglobin molecule structure: Tetramer containing two $\alpha$-like chains, two $\beta$-like chains, four heme groups.
- Regulation: Gene clusters control production via upstream locus control regions.
- $\alpha$-gene cluster: Located on chromosome 16.
    - Embryonic gene: Zeta ($\zeta$).
    - Adult genes: Alpha 1 ($\alpha1$), Alpha 2 ($\alpha2$).
- $\beta$-gene cluster: Located on chromosome 11.
    - Embryonic gene: Epsilon ($\epsilon$).
    - Fetal genes: Gamma 1 ($\gamma1$), Gamma 2 ($\gamma2$).
    - Adult genes: Delta ($\delta$), Beta ($\beta$).
...
- Transition: Embryonic globin replaced by fetal globin ($\gamma$).
- Correlation: Coincides with onset of definitive hematopoiesis.
- Major fetal hemoglobin: HbF ($\alpha2\gamma2$).
...
- Mechanism: BCL11A binds $\beta$-globin gene, silences $\gamma$-globin expression, represses HbF.
- Major adult hemoglobin: HbA ($\alpha2\beta2$).
...
- Minor adult hemoglobin: HbA2 ($\alpha2\delta2$).
...
- Final childhood/adult pattern: Achieved $\ge$ 6 months.
    - $\ge$ 95% HbA.
    - $\le$ 3.5% HbA2.
    - < 2.5% HbF.
...
|:--|:--|:--|:--|:--|
|Gower-1|$\zeta2\epsilon2$|Embryonic|< 6 weeks gestation|0%|
|Gower-2|$\alpha2\epsilon2$|Embryonic|< 6 weeks gestation|0%|
|Portland|$\zeta2\gamma2$|Embryonic|< 6 weeks gestation|0%|
|HbF (Fetal)|$\alpha2\gamma2$|Fetal|3rd trimester (70-80%)|< 2.5%|
|HbA (Adult)|$\alpha2\beta2$|Adult|Postnatal ($\ge$ 6 months)|$\ge$ 95%|
|HbA2 (Minor Adult)|$\alpha2\delta2$|Adult|Postnatal ($\ge$ 12 months)|$\le$ 3.5%|