---
{"dg-publish":true,"uptext":"Back to Index(🩸 Hematology and Oncology)","uplink":"/hematology/hematology/","permalink":"/hematology/fetal-hematopoiesis/","dgPassFrontmatter":true}
---
...
- Oxygen-sensing mechanism regulated by Hypoxia-Inducible Factor (HIF) family proteins (HIF-1$\alpha$, HIF-2$\alpha$).
...
- BCL11A transcription factor critical regulator; represses $\gamma$-globin expression (silencing fetal hemoglobin).

|Hemoglobin Type|Structure|Developmental Expression Pattern|
|:--|:--|:--|
|**Gower-1** (Embryonic)|$\zeta_2\epsilon_2$|Predominates <6 weeks; undetectable by 3 months.|
|**Gower-2** (Embryonic)|$\alpha_2\epsilon_2$|Predominates <6 weeks; undetectable by 3 months.|
|**Portland** (Embryonic)|$\zeta_2\gamma_2$|Predominates <6 weeks; undetectable by 3 months.|
|**HbF** (Fetal)|$\alpha_2\gamma_2$|Major fetal Hb; declines rapidly postnatally.|
|**HbA** (Adult)|$\alpha_2\beta_2$|First appears 1 month gestation; 30% at term.|
|**HbA2** (Adult Minor)|$\alpha_2\delta_2$|<1% at birth; reaches adult level (2.0-3.4%) by 12 months.|
