---
{"dg-publish":true,"uptext":"Back to Index (🍴 Gastroenterology)","uplink":"/gastrointestinal/gastroenterology/","permalink":"/gastrointestinal/biliary-atresia/","dgPassFrontmatter":true}
---
...
- Most common cause of pediatric [[Gastrointestinal/Liver Transplantation\|liver transplantation]] worldwide.
...
|:--|:--|
|**Isolated [[Gastrointestinal/Biliary Atresia\|Biliary Atresia]]**|Accounts for 80-90% of cases. Typical variant. Elevated direct bilirubin at 24-48 hours implies prenatal onset.|
|**Syndromic [[Gastrointestinal/Biliary Atresia\|Biliary Atresia]]**|Accounts for ~15% of cases. Associated with [[Gastrointestinal/Biliary Atresia\|biliary atresia]] splenic malformation (BASM) syndrome. Features include polysplenia/asplenia, situs inversus, absent inferior vena cava, preduodenal portal vein, cardiac anomalies.|
|**Cystic [[Gastrointestinal/Biliary Atresia\|Biliary Atresia]]**|Accounts for ~5% of cases. Obvious cyst within obliterated biliary tree. Detectable on antenatal ultrasound.|
|**CMV IgM-Positive [[Gastrointestinal/Biliary Atresia\|Biliary Atresia]]**|Accounts for ~10% of cases. Non-Caucasian predominance, older age at diagnosis, higher aspartate aminotransferase, larger spleens, prominent CD4+ Th1+ T-cell infiltrate. Associated with poorer surgical outcome.|
...
|:--|:--|
|**Medical**|Neonatal hepatitis, alpha-1 antitrypsin deficiency, Alagille syndrome (paucity of interlobular bile ducts), progressive familial intrahepatic cholestasis (PFIC), congenital TORCH/CMV infections, [[Metabolic Disorders/Galactosemia\|galactosemia]].|
...
|**Hepatobiliary Scintigraphy (HIDA)**|Normal hepatic uptake with failure of biliary excretion into bowel at 24 hours. High negative predictive value; visible intestinal excretion effectively rules out [[Gastrointestinal/Biliary Atresia\|biliary atresia]].|
...
- Indicated for failed KPE (persistent uncorrectable jaundice), decompensated cirrhosis, intractable [[Gastrointestinal/Portal Hypertension\|portal hypertension]], or severe growth failure.
...
- **[[Gastrointestinal/Portal Hypertension\|Portal Hypertension]]:** Results from progressive hepatic fibrosis. Manifests as esophageal/gastric varices, hypersplenism, ascites. Managed via endoscopic surveillance, variceal banding, or portosystemic shunts.
...
- Overall survival reaches 93% with integrated Kasai portoenterostomy and [[Gastrointestinal/Liver Transplantation\|liver transplantation]] programs.