---
{"dg-publish":true,"uplink":"/gastrointestinal/gastroenterology/","uptext":"Back to Index (🍴 Gastroenterology)","permalink":"/gastrointestinal/acute-diarrhea/","dgPassFrontmatter":true}
---
...
- _Note:_ Severe malnutrition with shock requires slower resuscitation (15 mL/kg over 1 hour) due to heart failure risk. Use half-normal saline with 5% dextrose.
...
- **Dose:** 5 mg/day elemental zinc for 10-14 days. #recent 
- **Outcome:** Significantly reduces severity, duration, and risk of persistent diarrhea/reinfection over next 3 months.

#### Probiotics

- **Efficacy:** Strain-dependent. Documented to reduce diarrhoeal duration by ~1 day, primarily in viral (Rotavirus) gastroenteritis.
- **Recommended Strains:** _Lactobacillus rhamnosus_ GG (LGG) (≥10^10 CFU/day) and _Saccharomyces boulardii_ (250-750 mg/day) for 5-7 days.
...
Empiric antibiotics are generally **not indicated** for acute watery diarrhoea (mostly viral). Indiscriminate use promotes resistance, disrupts microbiome, and prolongs carrier states (e.g., _Salmonella_).
...
5. **Parasitic Infections:** _Giardia lamblia_ or _Entamoeba histolytica_ with persistent symptoms. Tinidazole, Nitazoxanide, or Metronidazole.
